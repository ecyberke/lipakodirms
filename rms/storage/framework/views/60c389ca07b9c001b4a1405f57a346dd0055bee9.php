						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Pay Tenant Bill</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="<?php echo e(route('tenant.payNowadmin', $deposit_data->id )); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select  class="form-control select2-show-search" style="width: 100%" name="invoice_type">
    
                                        
                                        <option value="Deposit Bill" selected>Deposit Bill</option>
                        ...
                        <div class="row">
                            <div id="tenantSelector" class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option value="<?php echo e($deposit_data->tenant_id); ?>" selected ><?php echo e($deposit_data->tenant_name); ?> | Ksh.<?php echo e(number_format($deposit_data->deposit_amount)); ?></option>
                         ...
                         <input class="form-control " type="text" id="example-text-input" name="tenant_bill_id"
                                        value="<?php echo e($deposit_data->id); ?>" hidden>
                            ...
                            <div class="col-md-6">
                                <label>Amount<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="<?php echo e($deposit_data->deposit_amount); ?>" readonly>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Make Payment</button>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/tenants/pay_bill.blade.php ENDPATH**/ ?>