                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div id="tenantSelector" class="col-md-6">
                                ...
                                <select class="js-example-basic-single select" style="width: 100%" name="apartment_id">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $apartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apartment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($apartment->apartment_id); ?>"><?php echo e($apartment->apartment->name); ?> | To Pay: <?php echo e($apartment->balance); ?></option>
                            ...
                            <div id="invoiceSelector" class="col-md-6">
                                ...
                                <option value="<?php echo e($pay->landlord_id); ?>">Type: Agency Bill  To Pay: <?php echo e($pay->balance); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rms\rms\resources\views/bills/pay.blade.php ENDPATH**/ ?>