	...
	<!-- end row -->
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">                       
                     <p class="text-muted m-b-30 font-14">After successful registration of the property owner, proceed and click add property button to add property.
                        </p>
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="p-20">
                            ...
                            <form action="<?php echo e(route('landlord.store')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="id"
                                                    value="<?php echo e(old('id')); ?>" pattern=".{12,}"   required title="Phone number must begin with 254 and contain 12 characters" maxlength="12">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="landlordid_number" value="" id="passport">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Country</label>
                                            <div>
                                                <select class="js-example-basic-single select" style="width: 100%" id="country" name="country">
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_id" value="<?php echo e(old('emergency_id')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/landlords/register.blade.php ENDPATH**/ ?>