...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
    <form action="<?php echo e(route('bill.payNow')); ?>" method="post">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <select id="invoiceTypeSelector" class="js-example-basic-single select" style="width: 100%" name="type">
    
                                        
                                        <option value="property" selected>Rent Collection Bills</option>
                                            <option value="agency">Other Bills</option>
                        ...
                        <div class="row">
                            <div id="tenantSelector" class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                <select class="js-example-basic-single select" style="width: 100%" name="id">
                                    ...
                                    <?php $__currentLoopData = $apt_grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $apt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($apt['id']); ?>"><?php echo e($apt['landlord_name']); ?> | To Be Paid: <?php echo e($apt['amount']); ?></option>
                            ...
                            <div id="invoiceSelector" class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                <select class="js-example-basic-single select" style="width: 100%" name="landlord_id">
                                ...
                                <option value="<?php echo e($pay->id); ?>">Type: Agency Bill  To Pay: <?php echo e($pay->balance); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/lesa-demo/rms/resources/views/bills/pay.blade.php ENDPATH**/ ?>