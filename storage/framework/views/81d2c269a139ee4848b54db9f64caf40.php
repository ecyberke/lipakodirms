						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">All Tenants Payment Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="<?php echo e(route('report.tenant_income_report')); ?>" method="get" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="title text-center">
                    <h2>ALL TENANT PAYMENT REPORT</h2>
                </div>
            </div>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                           ...
                           <p><strong>Total Expected:</strong> <span>Kshs. <?php echo e(number_format($totals['total_payable'])); ?></span></p>
                    ...
                    <div class="row table-responsive   ">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">-->
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th><?php echo e($entry['property_name']); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/tenant_income.blade.php ENDPATH**/ ?>