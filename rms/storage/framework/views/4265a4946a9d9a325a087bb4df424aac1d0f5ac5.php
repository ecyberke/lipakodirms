                            ...
                            <div class="card-box">
                                ...
                                <div class="clearfix">
                                    <div class="float-left">
                                         <img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" alt="Lesa Logo" height="100">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 offset-xs-2 float-right" style="float:right;text-align:right;">
                                       ...
                                       <h3 class="m-0 d-print-none">RENT INVOICE</h3>
                              ...
                              <div class="row mt-3">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mt-4 table-centered">
                                                <thead>
                                                 ...
                                                 <tbody>
                                 <?php if($invoice->type == 'Monthly Rent' || $invoice->type == 'rent and deposit' || $invoice->type == 'House Viewing' ): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell">Electricity/Water Deposit </td>
                                ...
                                <div class="row">
                                    <div class="col-xs-9">
                                 	...
                                 	<?php if($invoice->balance > 0): ?>
                                            <h6 class="text-muted">How to pay</h6>
                                            ...
                                            <small class="text-muted">
                                             ...
                                             <?php endif; ?>
                                            All rent payments are due on or before 5th-<?php echo e($invoice->rent_month); ?>
...
</html><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/invoices/invoicepf.blade.php ENDPATH**/ ?>