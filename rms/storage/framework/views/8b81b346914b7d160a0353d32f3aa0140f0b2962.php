		...
		<div class="page relative">
			<div class="page-content">
				<div class="container text-center">
					<div class="display-2 text-primary mb-5 font-weight-bold">We have migrated to</div>
					<h1 class="h3  mb-3 font-weight-bold">Lesa Property Management System</h1>
					<p class="h5 font-weight-normal mb-4 leading-normal">Please visit<br> <strong>https://rms.lesaproperty.co.ke/</strong></p>
					<div class="row">
						<div class="col-md-6 d-block mx-auto mb-4">
							<div class="row">
								<div class="col text-left">
									<span class="badge badge-primary badge-pill">Migration Status</span>
								</div>
								<div class="col col-auto">
									<div class="fs-18 font-weight-bold">100%</div>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="progress-wrapper mb-5 col-md-6 d-block mx-auto">
							<div class="progress progress-md">
								<div class="progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;"></div>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/coming.blade.php ENDPATH**/ ?>