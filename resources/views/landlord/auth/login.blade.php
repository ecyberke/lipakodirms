				...
				<div class="p-5">
                    ...
                    <div class="form-group" >
                       <div class="input-group mb-4">
                        ...
                        <input id="username" style="width:80%" type="text" class="form-control @error('username') is-invalid @enderror"
                            name="account_number" value="{{ old('account_number') }}" required autocomplete="off" autofocus placeholder="e.g. LKL00001" style="width:80%;text-transform:uppercase;">
