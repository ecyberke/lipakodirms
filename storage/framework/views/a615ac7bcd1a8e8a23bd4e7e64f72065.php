    ...
    .menutitles{
				...
				<div class="app-sidebar app-sidebar2">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="<?php echo e(route('home')); ?>">
							<img src="<?php echo e(URL::asset('assets/images/lipakodi_main_logo.png')); ?>" style= "width:100px; height:60px;" class="header-brand-img desktop-lgo"  alt="LIA">
							<img src="<?php echo e(URL::asset('assets/images/lipakodi_main_logo.png')); ?>" style= "width:100px; height:60px;"  class="header-brand-img dark-logo" alt="LIA">
							<img src="<?php echo e(URL::asset('assets/images/lipakodi_main_logo.png')); ?>" class="header-brand-img mobile-logo" alt="LIA">
							<img src="<?php echo e(URL::asset('assets/images/lipakodi_main_logo.png')); ?>" class="header-brand-img darkmobile-logo" alt="LIA">
						</a>
					</div>
				</div>
				<aside class="app-sidebar app-sidebar3">
					...
					<ul class="side-menu">
						...
						<?php endif; ?>
						<li class="slide">
							<a class="side-menu__item"  href="<?php echo e(route('email.inbox')); ?>">
							<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M17.388,4.751H2.613c-0.213,0-0.389,0.175-0.389,0.389v9.72c0,0.216,0.175,0.389,0.389,0.389h14.775c0.214,0,0.389-0.173,0.389-0.389v-9.72C17.776,4.926,17.602,4.751,17.388,4.751 M16.448,5.53L10,11.984L3.552,5.53H16.448zM3.002,6.081l3.921,3.925l-3.921,3.925V6.081z M3.56,14.471l3.914-3.916l2.253,2.253c0.153,0.153,0.395,0.153,0.548,0l2.253-2.253l3.913,3.916H3.56z M16.999,13.931l-3.921-3.925l3.921-3.925V13.931z"></path></svg>
						...
						<li class="slide">
							...
							<span class="side-menu__label">List Logs</span></a>
                                            ...
                                            <li><a href="<?php echo e(route('onboarding.wizard')); ?>" class="slide-item"><i class="fas fa-magic me-1"></i> Setup Wizard</a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<?php if(Auth::user()->is_admin==2 || Auth::user()->is_admin==1 ): ?>
								<li><a href="<?php echo e(route('report.tenant_balance')); ?>" class="slide-item"> Tenant Balances</a></li>
								<li><a href="<?php echo e(route('report.tenant_income')); ?>" class="slide-item"> All Tenant Payments</a></li>
								<!--<li><a href="<?php echo e(route('report.tenant_month_income')); ?>" class="slide-item"> Monthly Tenant Payments</a></li>-->
