            ...
            <div class=" card">
                <div class="card-body">
                    ...
                    <div class="info-list">
                        ...
                        <h5>Tenant Name</h5>
                        <?php if($service_requests->tenant_id == null): ?>
                        <p> <?php echo e($service_requests->full_name); ?>
                    ...
                    <div class="info-list">
                        ...
                        <h5>House</h5>
                        <?php if($service_requests->house_id == null): ?>
                    ...
                    <div class="info-list">
                        ...
                        <p> No Phone Number Specified
                            ...
                            <?php else: ?>
                            <p> <?php echo e($service_requests->tenant->phone); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/servicerequests/show.blade.php ENDPATH**/ ?>