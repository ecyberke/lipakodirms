                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        <div class="staff-id">Tenant ID : {{ $tenant->id}}</div>
                                        <div class="small doj text-muted mb-2">Date of Join :
                                            {{ $tenant->created_at->diffForHumans() }}</div>
                                        <div class="mb-2"><a class="btn btn-sm btn-custom"
                                ...
                                <div class="col-md-7">
                                    <ul class="personal-info">
                                        <li>
                                            ...
                                            <div class="text"><a href="">{{ $tenant->phone_no}}</a></div>
                                        </li>
                                        <li>
            ...
            <div class="row">
                <div class="col-md-6 d-flex">
                    <div class="card  flex-fill">
                        <div class="card-body">
                            <h3 class="card-title">Current Overpayment </h3>
                            <ul class="personal-info">
                                <li>
                                    <div class="title">Amount.</div>
                                    <div class="text">Ksh {{ number_format($overpayment)}}</div>
                                </li>
                    ...
                    <div class="card profile-box flex-fill">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered custom-table table-nowrap datatable">
                                    <thead>
                                        <tr>
                                            <th>Hse No</th>
                                            <th>Type</th>
                                ...
                                <table class="table table-bordered  table-nowrap datatable" id="invoices-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('invoice.show',$invoice->id)}}" class="btn btn-sm btn-primary">Download</a> </td>
                                        </tr>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered  table-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>Ksh {{number_format($placement->amount)}}</td>
                                            <td class="text-uppercase">{{ $placement->house->house_no}}</td>
                                            <td>{{ $placement->placement_month}}</td>
                                        </tr>
