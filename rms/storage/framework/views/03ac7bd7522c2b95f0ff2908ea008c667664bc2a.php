                         ...
                         <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <label >ID Number</label>
                                    <input type="text" class="form-control" name="user_id" value="<?php echo e($user->user_id); ?>">
                                </div>
                                <div class="col-sm-6">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/authorization/edit.blade.php ENDPATH**/ ?>