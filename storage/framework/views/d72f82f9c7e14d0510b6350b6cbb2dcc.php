...
<!-- Jquery js-->
<script src="<?php echo e(URL::asset('assets/js/vendors/jquery-3.5.1.min.js')); ?>"></script>
<!-- Bootstrap4 js-->
...
<!--Sidemenu js-->
<script src="<?php echo e(URL::asset('assets/plugins/sidemenu/sidemenu.js')); ?>"></script>
<!-- Clipboard js -->
...
<script src="<?php echo e(URL::asset('assets/plugins/p-scrollbar/p-scroll1.js')); ?>"></script>
<?php echo $__env->yieldContent('js'); ?>
<!-- Custom js-->
<script src="<?php echo e(URL::asset('assets/js/custom.js')); ?>"></script>
<?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/layouts/footer-scripts.blade.php ENDPATH**/ ?>