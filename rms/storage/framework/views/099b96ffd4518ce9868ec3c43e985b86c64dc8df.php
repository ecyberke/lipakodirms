...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							 <form action="<?php echo e(route('tenant.updateallocateHouse',$house_tenants->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <label >Select Tenant <span class="text-danger">*</span></label>
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id" readonly>

                                    <option value="<?php echo e($house_tenants->tenant_id); ?>"><?php echo e($house_tenants->tenant->full_name); ?></option>
                            ...
                            <label >Select Property <span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%" id="apartment_id" name="apartment" required>
                            ...
                            <div class="row">
                                ...
                                <label >Select House<span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%" name="house_id" id="houses_select">
                                        <option value="<?php echo e($house_tenants->house_id); ?>"><?php echo e($house_tenants->house->house_no); ?></option>
                                ...
                                <label >Monthly
                                    ...
                                    <input class="form-control" type="text" id="house-rent" value="<?php echo e($house_tenants->house->rent->amount); ?>" readonly>
                                    </div>
                                </div>
                            </div><br>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <label >Rent to Pay</label>
                                    ...
                                    <input class="form-control" type="number" id="house-rent" name="rent" value="" required>
                                    </div>
                                </div>
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <div class="cal-icon">
                                        <input class="form-control" type="date" name="placement_date"
                                            value="<?php echo e($house_tenants->placement_date); ?>">
                                    </div>
                                </div>
                      ...
                      <div class="row">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Reassign House</button>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/tenants/assign_roomedit.blade.php ENDPATH**/ ?>