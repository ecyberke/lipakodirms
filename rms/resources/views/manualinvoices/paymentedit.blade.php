...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="{{ route('invoice.payInvoiceNowupdate', $managerpayment->id)}}" method="post" class="card">
        @csrf
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div>
                                      ...
                                      <input class="form-control " type="text" id="example-text-input" name="invoice_type"
                                        value="{{$managerpayment->invoice_type}}" readonly>
                        ...
                        <div class="row">
                            @if ($managerpayment->invoice_type === 'property')
                            <div  class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option value="{{$managerpayment->tenant_id}}">{{$managerpayment->full_name}}</option>
                                  </select>
                                </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                        ...
                                        value="INV {{$managerpayment->tenant_id}}" readonly>
