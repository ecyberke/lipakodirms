						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Owner's Details</li></li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
                ...
                <div class="card">
                    <div class="card-body">                       
                        ...
                        <div class="p-20">
                            ...
                            <form action="<?php echo e(route('landlord.update',$landlord->id)); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            value="<?php echo e($landlord->full_name); ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="landlordid_number" value="<?php echo e($landlord->landlordid_number); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="email"
                                                    value="<?php echo e($landlord->email); ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="address"
                                                    value="<?php echo e($landlord->address); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="town"
                                                    value="<?php echo e($landlord->town); ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control select2-show-search" id="country" name="country">
                                                    <option value="<?php echo e($landlord->country); ?>"><?php echo e($landlord->country); ?></option>
                                ...
                                <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="bank_name" value="<?php echo e($landlord->bank_name); ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="bank_branch"
                                                    value="<?php echo e($landlord->bank_branch); ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="bank_acc_name" 
                                                    value="<?php echo e($landlord->bank_acc_name); ?>">
                                            </div>
                                        </div>
                                    </div> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="bank_acc_no"
                                                    value="<?php echo e($landlord->bank_acc_no); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                                <label >Contract<span class="text-muted test-small"></span></label>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_person" value="<?php echo e($landlord->emergency_person); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_id" value="<?php echo e($landlord->emergency_id); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="tel" class="form-control" name="emergency_number" value="<?php echo e($landlord->emergency_number); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="relationship" value="<?php echo e($landlord->relationship); ?>">
                                    </div>
                                </div>
                            </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/landlords/edt.blade.php ENDPATH**/ ?>