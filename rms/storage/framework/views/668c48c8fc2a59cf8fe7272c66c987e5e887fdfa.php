						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Company Documents</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							...
							<div class="col-lg-8 col-xl-9">
								<div class="row">
									...
									<div class="col mb-4">
									    <form action="<?php echo e(route('tenant.contract')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
									     <div class="">
                                                <input type="file" name="filenames" class="myfrm form-control" multiple>
                                            </div><br>
                                             <button type="submit" class="btn btn-success waves-effect waves-light">
                                                <i class="fe fe-plus"></i> Upload
                                            </button>
                                            <button type="reset" class="btn btn-secondary waves-effect m-l-5">
                                                X Cancel
                                            </button>
										<!--<a href="#"  class="btn btn-primary"><i class="fe fe-plus"></i> Upload Files</a>-->
										</form>
										...
										<div class="card border p-0 shadow-none">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Change of Management-Lesa-1.pdf')); ?>"><i class="fe fe-eye mr-2"></i>View</a>
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="<?php echo e(URL::asset('assets/images/files/file.png')); ?>" alt="img" class="br-7">
												</div>
												<h6 class="mb-1 font-weight-semibold mt-4">Change of Management Lesa 1</h6>
												<span class="text-muted">334.87kb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Change of Management-Lesa-2.pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
															<!--<a class="dropdown-item" href="#"><i class="fe fe-share mr-2"></i> Share</a>-->
															<!--<a class="dropdown-item" href="#"><i class="fe fe-download mr-2"></i> Download</a>-->
															<!--<form method="POST" action="<?php echo e(url('filemanager/delete_file/Change of Management-Lesa-1.pdf')); ?>">-->
               <!--                                     <?php echo csrf_field(); ?>-->
               ...
               <!--                                 </form>-->
											...
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">Change of Management Lesa 2</h6>
												<span class="text-muted">334.18kb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Change of Management-Owner.pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">Change of Management-Owner</h6>
												<span class="text-muted">416.57kb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Company Profile Current.pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">LESA Int Agencies Current Company Profile</h6>
												<span class="text-muted">1.11mb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Demand notice current.pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">Demand notice current.pdf</h6>
												<span class="text-muted">360.84 </span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Late Rent Payment Notice current.pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">Late Rent Payment Notice current</h6>
												<span class="text-muted">1.29mb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Lesa-Letterhead-Print (pdf).pdf')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">Lesa Int Agencies Letterhead Print</h6>
												<span class="text-muted">384.07kb</span>
											</div>
										</div>
									</div>
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/Notice on Cleanliness.docx')); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="<?php echo e(URL::asset('assets/images/files/word.png')); ?>" alt="img" class="br-7">
												</div>
												<h6 class="mb-1 font-weight-semibold mt-4">Notice on Cleanliness</h6>
												<span class="text-muted">200.06kb</span>
											</div>
										</div>
									</div>
									<div class="row">
                        ...
                        <i>No files found</i>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										...
										<div class="card border p-0 shadow-none">
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="<?php echo e(asset('rms/storage/app/filemanager/'.$num)); ?>"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4"><?php echo e($num); ?></h6>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										<div class="card border p-0 shadow-none">
											...
											<div class="card-body pt-0 text-center">
												<div class="file-manger-icon">
													<img src="<?php echo e(URL::asset('assets/images/files/folder.png')); ?>" alt="img" class="br-7">
												</div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/filemanager/index.blade.php ENDPATH**/ ?>