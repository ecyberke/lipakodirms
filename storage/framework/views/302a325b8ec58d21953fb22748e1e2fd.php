							...
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="#">
										<img src="<?php echo e(URL::asset('assets/images/lesa.png')); ?>" class="header-brand-img desktop-lgo" alt="Dashtic logo">
										<img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" class="header-brand-img dark-logo" alt="Dashtic logo">
										<img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" class="header-brand-img mobile-logo" alt="Dashtic logo">
										<img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
									</a>
										...
										<div class="dropdown header-notify pl-4">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
												...
												<div class=" text-center p-2 border-top">
													<a href="<?php echo e(url('/chat/' . $page='email-inbox')); ?>" class="">You have new emails</a>
												</div>
											</div>
										</div>
