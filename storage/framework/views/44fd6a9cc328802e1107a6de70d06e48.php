    ...
    <div class="row">
        <div class="col-md-8">
            <div class="job-info job-widget">
                <h3 class="job-title"><?php echo e($house->house_no); ?> <?php if($house->apartment->active == 0): ?><a class="btn btn-sm btn-danger"
            href="<?php echo e(route('apartment.edit', $house->apartment->id)); ?>">Activate Property</a>
            <?php endif; ?></h3>
                ...
                <ul class="job-post-det mb-2">
                    ...
                    <li><i class="fa fa-home"></i> Property: <span
                            class="text-blue"><?php echo e($house->apartment->name); ?> <?php if($house->apartment->active == 0): ?> <span
                            style="color:red;">Inactive</span> <?php endif; ?></span> </li>
                </ul>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/houses/show.blade.php ENDPATH**/ ?>