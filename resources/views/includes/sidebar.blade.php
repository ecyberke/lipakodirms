		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="submenu "><a href="#"><i class="la la-money"></i> &nbsp;<span>Income </span> <span
					...
					<ul style="display: none;">
						...
						<li><a href="{{ route('incomes.index') }}"
								class="{{ Route::currentRouteName() === 'incomes.index' ? 'active' : '' }}"><i class="la la-list-ul"></i> &nbsp;List Income</a>
						</li>

						{{-- <li><a href="#"
								class="{{ Route::currentRouteName() === 'income.company' ? 'active' : '' }}"><i class="la la-circle"></i> &nbsp; Add</a>
				</li>
				<li><a href="#"
						class="{{ Route::currentRouteName() === 'income.landlord' ? 'active' : '' }}"><i class="la la-circle"></i> &nbsp; List</a></li> --}}
				...
				<!-- //to be reviewed later
							...
							<li><a href="#"
								class="{{ Route::currentRouteName() === 'deposit.list' ? 'active' : '' }}">All
								Deposits</a></li>

						<li><a href="#"
								class="{{ Route::currentRouteName() === 'deposit.apartment' ? 'active' : '' }}">Sum By
								Apartments</a></li>

						<li><a href="#"
								class="{{ Route::currentRouteName() === 'deposit.sort' ? 'active' : '' }}">Sort By
								Apartments</a>
							</li>
				...
				<!-- <li><a href="{{ route('deposit.list')}}"
						...
						<li><a href="{{ route('deposit.apartment')}}"
								class="{{ Route::currentRouteName() === 'deposit.apartment' ? 'active' : '' }}">Sum By
								Apartments</a></li>

						<li><a href="{{ route('deposit.sort')}}"
								class="{{ Route::currentRouteName() === 'deposit.sort' ? 'active' : '' }}">Sort By
								Apartments</a>
							</li>
						<li class="d-none"><a href=""
								class="{{ Route::currentRouteName() === 'deposit.edit' ? 'active' : '' }}"></a>
							</li>
						//to be reviewed later -->
			</ul>
			</li>
			...
			<li class="submenu ">
				<a href="#"><i class="la la-cart-arrow-down"></i> &nbsp;<span> Expenses </span> <span class="menu-arrow"></span></a>
				<ul style="display: none;">



					<li><a href="#"
							class="{{ Route::currentRouteName() === 'agencyexpenses.index' ? 'active' : '' }}"><i class="la la-institution"></i> &nbsp;Agency</a>
					</li>
					<li><a href="#"
							class="{{ Route::currentRouteName() === 'expenses.index' ? 'active' : '' }}"><i class="la la-building-o"></i> &nbsp;Properties</a>
					</li>
				</ul>
			...
			<li>
				<a href="{{ route('invoice.all') }}"
					class="{{ Route::currentRouteName() === 'invoice.all' ? 'active' : '' }}"><i class="la la-file"></i> &nbsp; <span>Invoices</span></a>
			</li>
			{{-- <li><a href="{{ route('invoice.all') }}"
			class="{{ Route::currentRouteName() === 'invoice.all' ? 'active' : '' }}"><i class="la la-file"></i> &nbsp;<span>Invoices</span></a></li> --}}
			{{-- <li class="submenu ">
					<a href="{{ route('invoice.all') }}"><i class="la la-file"></i>&nbsp; <span> Invoices </span> <span
				class="menu-arrow"></span></a>
			<ul style="display: none;"> --}}


				{{-- <li><a href="{{ route('invoice.prepare') }}"
				class="{{ Route::currentRouteName() === 'invoice.prepare' ? 'active' : '' }}"><i class="la la-circle"></i> &nbsp;Tenants Bills</a>
				</li> --}}
				{{-- <li><a href="#"
							class="{{ Route::currentRouteName() === 'manualinvoice.create' ? 'active' : '' }}"><i class="la la-plus-circle"></i> &nbsp;Create Invoice</a>
				</li> --}}



				{{-- <li><a href="{{ route('invoice.unpaid') }}"
				class="{{ Route::currentRouteName() === 'invoice.unpaid' ? 'active' : '' }}"><i class="la la-check-circle"></i> &nbsp;Pay Invoices</a>
				</li> --}}

				{{-- </ul>
				</li>  --}}
				{{-- <li class="submenu">
					<a href="#"><i class="la la-money"></i>&nbsp; <span> Payments </span> <span
							class="menu-arrow"></span></a>
					<ul style="display: none;"> --}}
				{{-- <li><a href="{{ route('placementfee.apartment')}}"
				class="{{ Route::currentRouteName() === 'placementfee.apartment' ? 'active' : '' }}">Placements fee
				By Month</a></li>

				<li><a href="{{ route('placementfee.sort')}}"
						class="{{ Route::currentRouteName() === 'placementfee.sort' ? 'active' : '' }}">Placements fee By
						Apartments</a></li>

				<li class="d-none"><a href="" class="{{ (																
								Route::currentRouteName() === 'placementfee.edit') ? 'active' : '' }}">
					</a>
				</li> --}}
				...
				<li class="submenu">
					<a href="#"> <i class="la la-folder-open"></i>&nbsp; <span> File Manager </span> </a>
				</li>

				<ul style="display: none;">
					<!-- <li><a href="#"
								class="{{ Route::currentRouteName() === 'invoice.prepare' ? 'active' : '' }}">Prepare
								Invoice</a>
						</li>
						<li><a href="#"
								class="{{ Route::currentRouteName() === 'invoice.all' ? 'active' : '' }}">List
								Invoices</a>
						</li>
						<li><a href="#"
								class="{{ Route::currentRouteName() === 'invoice.unpaid' ? 'active' : '' }}">Pay Due
								Invoices</a>
						</li>
						<li><a href="#"
								class="{{ Route::currentRouteName() === 'invoice.overpayments' ? 'active' : '' }}">List
								Overpayments</a>
						</li> -->
					<!-- <li><a href="{{ route('invoice.prepare') }}"
								class="{{ Route::currentRouteName() === 'invoice.prepare' ? 'active' : '' }}">Prepare
						...
						<li><a href="{{ route('invoice.overpayments') }}"
								class="{{ Route::currentRouteName() === 'invoice.overpayments' ? 'active' : '' }}">List
								Overpayments</a>
						</li> -->

					<li class="d-none"><a href="" class="{{ (
								Route::currentRouteName() === 'invoice.month' ||								
								Route::currentRouteName() === 'invoice.overpayments' ||								
								Route::currentRouteName() === 'invoice.show' ||								
								Route::currentRouteName() === 'overpayment.edit' ||								
								Route::currentRouteName() === 'invoice.pay') ? 'active' : '' }}">
						</a>
					</li>
				</ul>
				</li>
			...
			<li><a href="{{route('apartment.list')}}"
					class="{{ Route::currentRouteName() === 'apartment.list' ? 'active' : '' }}"><i class="la la-building-o"></i>&nbsp;All Properties</a></li>
			...
			<li class="submenu">
				{{-- <a href="#"><i class="la la-institution"></i> <span> House Options</span> <span
					...
					<ul style="display: none;"> --}}
			<li><a href="#"
					class="{{ Route::currentRouteName() === 'house.list' ? 'active' : '' }}"><i class="la la-users"></i>&nbsp;Tenants</a>
			</li>
			<li><a href="#"
					class="{{ Route::currentRouteName() === 'house.vacant' ? 'active' : '' }}"><i class="la la-building-o"></i>&nbsp;Property Owners</a>
			</li>
			<li><a href="#"
					class="{{ Route::currentRouteName() === 'house.occupied' ? 'active' : '' }}"><i class="la la-institution"></i>&nbsp;Agency</a>
			</li>
			<li><a href="#"
