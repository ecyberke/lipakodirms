                        ...
                        <div class="row">
                            ...
                            <label >Select Property <span class="text-danger">*</span></label>
                                ...
                                <select class="form-control select2-show-search" style="width: 100%"  name="apartment">
                                 ...
                                 <input hidden value="notice" type="text" name="type"/>
                            </div>
                        </div><br>
                        <!--<div class="row">-->
                        <!--    <div class="col-sm-6">-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/notice_report.blade.php ENDPATH**/ ?>