						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Add Bills Category</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
@section('content')
	...
	<form action="{{ route('billscategories.store') }}" method="POST" class="card">
    @csrf
    <div class="card-body">
...
<script>
    ...
    $('#houses_select').change(function () {
        ...
        $.ajax({
            url: "{!! route('ajax.house.tenant') !!}",
            method: 'POST',
            data: { id: houseId, _token: token },
            success: function (data) {
                $('#tenant-name-display').val(data.tenant_name);
                $('#tenant-id').val(data.tenant_id);
            },
            error: function () {
