			...
			<div class="page-single">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="account-footer">
                        <p>Remember your password? <a href="{{ route('home')}}">Login</a></p>
                    </div>
                </form>
											</div>
											</div>
									...
									<div class="text-center pt-4">
										<div class="font-weight-normal fs-16">Forget it <a class="btn-link font-weight-normal" href="{{ route('home')}}">Send me back</a></div>
									</div>
								</div>
							</div>
						</div>
