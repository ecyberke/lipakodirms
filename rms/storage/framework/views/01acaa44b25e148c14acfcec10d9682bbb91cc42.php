                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <label >Select Owner <span class="text-danger">*</span></label>
                                ...
                                <select class="js-example-basic-single select" style="width: 100%"  name="owner_id">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/lesa-demo/rms/resources/views/report/landlordform.blade.php ENDPATH**/ ?>