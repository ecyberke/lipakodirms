...
<script>
    $(function () {
        $('#invoices-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('api.paymentsmanager.list'); ?>',
            "order": [[ 5, "desc" ]],
            columns: [ 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/eric/rms/resources/views/manualinvoices/paymentlist.blade.php ENDPATH**/ ?>