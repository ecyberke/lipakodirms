                    ...
                    <div class="profile-view">
                        ...
                        <div class="profile-basic">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                   <h4> <ul class="personal-info">
                                        <li>
                                            <div class="title">Phone: <?php echo e($landlord->id); ?></div>
                                           
                                        </li><br>
                                        
                                        <li>
                                            <div class="title">Physical Address: <?php echo e($landlord->address); ?></div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/landlords/show.blade.php ENDPATH**/ ?>