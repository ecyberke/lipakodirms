							...
							<div class="col-md-12 col-lg-4 col-xl-3">
								<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
										...
										<a href="{{ url('/chat/' . $page='email-important') }}" class="list-group-item list-group-item-action d-flex align-items-center active">
...
<script>
    $(function () {
        $('#bill-table').DataTable({
            ...
            serverSide: true,
             "pageLength": 10,
            ajax: '{!! route('api.chats.email-important') !!}',
