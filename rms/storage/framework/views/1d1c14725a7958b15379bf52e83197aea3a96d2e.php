...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
								...
								<div class="card overflow-hidden">
									...
									<div class="card-body">
										...
										<div class="row pt-4">
                                            ...
                                            <span class="text-success "> <?php echo e($invoice->house->house_no); ?></span> -  Rent Paid after every <strong><?php echo e($invoice->house->rent_const); ?> month(s)</strong> 
                                            ...
                                            <span class="text-success "> <?php echo e($invoice->house_name); ?></span> - Rent Paid after every <strong><?php echo e($invoice->house->rent_const); ?> month(s)</strong>
                                            <?php else: ?>
                            ...
                            <p class="text-muted"><strong>Pay via Lipa na Mpesa (Paybill)</strong><br>
                                                          ...
                                                          Account Number: <?php if($invoice->tenant_id != null): ?> <?php echo e($invoice->tenant->account_number); ?> <?php else: ?> <?php echo e($invoice->tenant_acc); ?> <?php endif; ?><br>
                                                          Amount: <?php echo e(number_format($invoice->balance )); ?><br>
                                        <?php endif; ?>   </p>
                                 <p class="text-muted"><i>All rent payments are due on or before 5th-<?php echo e($invoice->rent_month); ?></i></p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/invoices/invoice.blade.php ENDPATH**/ ?>