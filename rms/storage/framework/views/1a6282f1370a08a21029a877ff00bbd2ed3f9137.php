                                        ...
                                        <form action="<?php echo e(route('email.store')); ?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												<div class="row align-items-center">
													...
													<div class="col-sm-10">
														<select class="form-control select2-show-search" style="width: 100%"  name="receiver_id">

                                                          <option  value="">-----Select-----</option>
                                                          <?php $__empty_1 = true; $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                         <option value="<?php echo e($test->id); ?>"><?php echo e($test->email); ?> - <?php echo e($test->name); ?> </option>
											...
											<div class="form-group">
												<div class="row ">
													...
													<div class="col-sm-10">
													    &nbsp;<input type="radio"  id="impotant" name="important" value="1">&nbsp;<label for="important">Urgent</label>
													&nbsp; &nbsp; <input type="radio" id="impotant" name="important" value="0">&nbsp;<label for="important" checked>Not Urgent</label>
													</div>
												</div>
											</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/chats/email-compose.blade.php ENDPATH**/ ?>