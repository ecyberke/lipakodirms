                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" readonly value="{{ $house->apartment->name}}" >
                                </div>
                               
                                    <div class="col-sm-6">
                                    <label >House No <span class="text-danger">*</span></label>
                                    
                                    <input type="text" class="form-control text-uppercase" name="house_no" value="{{$house->house_no}}" >
                                </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <select class="js-example-basic-single js-states form-control" name="house_type" >
                                        <option selected>{{ $house->house_type}}</option>
                                    ...
                                    <select class="js-example-basic-single js-states form-control" name="rent_period" >
                                        <option selected value="{{ $house->rent_const}}">{{ $house->rent_const}} Month(s)</option>
                            ...
                            <input type="text" class="form-control" name="electricity" value="{{ $house->rent->electricity_bill }}">
                        </div>
                        <div class="col-sm-6">
                            <label >Water</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type = "number" class= "form-control"
                                           ...
                                           value       = "{{ $house->rent->water_bill }}" aria-describedby = "depositHelp">
                            ...
                            <label >Compound Cleaning and Maintenance</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type = "number" class= "form-control"
                                           ...
                                           value       = "{{ $house->rent->compound_bill}}" aria-describedby = "depositHelp">
                            ...
                            <label >Litter Collection</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type = "number" class= "form-control"
                                           ...
                                           value       = "{{ $house->rent->litter_bill }}" aria-describedby = "depositHelp">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control" name="house_description" value="{{$house->description}}">
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%"  name="notice" >
                                               ...
                                               <option selected disabled>@if($house->notice == 0) No Notice @else Under Notice @endif</option>
