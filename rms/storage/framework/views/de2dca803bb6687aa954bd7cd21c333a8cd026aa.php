						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Get Preprinted Form</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
        <form action="<?php echo e(route('doc.preprinted')); ?>" method="get">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-8">
                                    ...
                                    <button type="submit"  class="btn btn-success waves-effect waves-light">Download Form</button>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/report/preprintedform.blade.php ENDPATH**/ ?>