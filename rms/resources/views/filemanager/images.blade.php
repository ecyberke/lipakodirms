...
<div class="app-file-sidebar-left">
  ...
  <div class="app-file-sidebar-content">
    ...
    <div class="list-group list-group-messages ">
      ...
      <a href="{{ route('filemanager.images')}}"  class="list-group-item list-group-item-action" style="color: rgb(1, 111, 255);">
        
        Images
      </a>
      <a href="{{ route('filemanager.contract')}}" class="list-group-item list-group-item-action">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div style="display: flex; overflow: auto;">
                                        @if (count($house_imgs) > 0) 
                                        @foreach ($house_imgs as $number) 
                                        ...
                                        <div class="card m-2" style="max-width:13em; min-width:12em;">
                                            ...
                                            {{-- src="{{asset('rms/storage/app/filemanager/'.$num) }} --}}
                                            <div class="card-body">
                                              <h5 class="card-title">{{$number['details']['house_no']}}</h5>
                                              <h5 class="card-title">{{$number['details']['house_type']}}</h5>
                                              <h5 class="card-title">{{$number['details']['house_description']}}</h5>
