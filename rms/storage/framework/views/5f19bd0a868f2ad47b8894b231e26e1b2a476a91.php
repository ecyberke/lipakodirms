                                    ...
                                    <div class="col-sm-6">
                                        <label >Property
                                            ...
                                            <select class="form-control select2-show-search" style="width: 100%" name="landlord_id">
                                                <option class="text-muted">Select Owner</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/apartments/crate.blade.php ENDPATH**/ ?>