        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-20 pt-2">
                        <form action="{{ route('tenant.change')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                       <select class="js-example-basic-single select" style="width: 100%"  name="house_id">
                                        ...
                                        <option selected>{{ $house->house->house_no}}</option>

                                        @forelse ($house as $house)
                                        <option value="{{$house->house_id}}">{{ $house->house->house_no}}</option>
                                        @empty
