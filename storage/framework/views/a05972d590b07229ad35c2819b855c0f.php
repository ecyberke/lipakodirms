						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Agency Income Expense Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="<?php echo e(route('report.agency_income_expense_report')); ?>" method="get">
            <?php echo csrf_field(); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="title text-center">
                    <h2>AGENCY INCOME EXPENSE REPORT</h2>
                </div>
            </div>
        </div>
        <div class="content-page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6  float-right" style="float:right;text-align:right;">
                            <div class="mt-3 float-right">
                                <img src="https://rms.lesaproperty.co.ke/rms/assets/img/lesa.png" alt="" height="100">
                            </div>
                        </div>
                    </div>
                     <div class="row">
            <div class="col-12">
                <div class="title text-center">
                    ...
                    <div class=" ">
                        <table id="agency-status-table" class="" style="width: 100%;">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">-->
                            <thead>
                              <tr>
                                  
                                <th>Property Name</th>
                                <th class="text-right">Property Rent Paid</th>
                                <th class="text-right">Management Fee</th>
                              </tr>
                            </thead>
                            <tbody>
                                <?php $__currentLoopData = $properties_paid_rent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                               
                                <td ><?php echo e($property['apartment_name']); ?></td>
                                <td class="text-right"><?php echo e(number_format($property['total_paid_in'], 2)); ?></td>
                                <td class="text-right"><?php echo e(number_format(($property['total_paid_in']*($property['commission']/100)), 2)); ?></td>
                              </tr>
            ...
            <div class="col-12">
                <div class="title text-center">
                    <h4>OTHER AGENCY INCOME (CRM)</h4>
                </div>
            </div>
        </div>
        <div>
             <table id="agency-status-table2"  style="width: 100%;">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">-->
                            <thead>
                              <tr>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $agency_income; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                               
                                <td ><?php echo e(\Carbon\Carbon::parse($inc->created_at)->format('d M Y')); ?></td>
                                <td ><?php echo e($inc->full_name); ?></td>
                                  <td ><?php echo e($inc->phone); ?></td>
                                <td ><?php echo e(number_format($inc->fee, 2)); ?></td>
                              </tr>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-12">
                <div class="title text-center">
                    <h4>AGENCY EXPENSE</h4>
                </div>
            </div>
        </div>
                    <div >
                        <table id="agency-status-table1"  style="width: 100%;">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">-->
                            <thead>
                              <tr>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $agency_bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <tr>
                               
                                <td ><?php echo e(\Carbon\Carbon::parse($bill->created_at)->format('d M Y')); ?></td>
                                <td ><?php echo e($bill->description); ?></td>
                                <td ><?php echo e(number_format($bill->total_owned, 2)); ?></td>
                              </tr>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">
                             <thead>
                              ...
                              <tr>
                                <th colspan="4"> </th>
                                <th >Agency Income</th>
                                <th ><?php echo e(number_format($total_agency_commission, 2)); ?></th>
                              </tr>
                              <tr>
                                <th colspan="4"> </th>
                                <th >Agency CRM Income</th>
                                <th ><?php echo e(number_format($total_CRM, 2)); ?></th>
                              </tr>
                               <tr>
                                <th colspan="4"> </th>
                                <th >Agency Expense</th>
                                <th ><?php echo e(number_format($total_agency_bills, 2)); ?></th>
                              </tr>
                              <tr>
                                <th colspan="4"> </th>
                                <th >Agency Total Amount</th>
                                <th ><?php echo e(number_format(($total_agency_commission + $total_CRM - $total_agency_bills), 2)); ?></th>
                              </tr>
                            </tbody>
                          </table>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#agency-status-table1').DataTable({
            pageLength: 10,
            lengthMenu: [5, 10, 25, 50, 100],
            responsive: true,
        });
...
<script>
    $(document).ready(function() {
        $('#agency-status-table2').DataTable({
            pageLength: 10,
            lengthMenu: [5, 10, 25, 50, 100],
            responsive: true,
        });
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/income_expense.blade.php ENDPATH**/ ?>