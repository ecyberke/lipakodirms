...
<style>
    .menutitles{
				...
				<aside class="app-sidebar app-sidebar3">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a href="{{ route('bill.create') }}" class="slide-item"> Add Expense</a></li>
							      ...
							      <li><a href="{{ route('payowners.list') }}" class="slide-item"> List Expenses</a></li>
								<!--<li><a href="{{ route('bill.pay') }}" class="slide-item"> Pay Bill</a></li>-->
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<!--<li><a href="{{ route('manualinvoice.create') }}" class="slide-item">Add Invoice</a></li>-->
								...
								<li><a href="{{ route('manualinvoice.paymentlist') }}" class="slide-item">Approve Payments</a></li>@endif
						...
						<svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
							...
							<ul class="slide-menu">
								...
								<li><a href="{{ route('service-providers.index') }}" class="slide-item"> List Service Provider</a></li>
						...
						<!--<li class="slide">-->
						<!--	<a class="side-menu__item"  href="{{ route('filemanager.index')}}">-->
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<!--<li><a href="{{ route('report.tenant_month_income') }}" class="slide-item"> Monthly Tenant Payments</a></li>-->
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<!--<li><a href="{{ route('report.month_income') }}" class="slide-item"> Monthly Properties Income</a></li>-->
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<!--<li><a href="{{ route('report.preprintedform') }}" class="slide-item" target="blank"> Preprinted form</a></li>-->
     ...
     <!--                           </form>-->
					...
					<!--					<a class="text-primary d-block" href="{{ url('/' . $page='#') }}">Company Email</a>-->
					<!--					<a class="text-primary d-block" href="{{ url('/' . $page='#') }}">Company Tel</a>-->
					<!--				</div>-->
					...
					<!--			</div>-->
					<!--			<div class="ml-auto">-->
					<!--				<a class="nav-link icon p-0" href="{{route('admin.notification')}}">-->
