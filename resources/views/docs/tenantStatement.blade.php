                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <p><strong>Property:</strong> <span>
                                                                   {{$other_info['apartment_name'] }}
                                                                  </span></p>
                            <p><strong>Property Owner:</strong> <span>
                                                                      {{$other_info['landlord_name'] }}
                                                                      </span></p>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody style="padding-top:0px; padding-bottom:0px;">
                                <tr style="padding-top:0px; padding-bottom:0px;">
                                    ...
                                    <td style="padding-top:0px; padding-bottom:0px;">{{$deposit_sum}}</td>
                                    <td style="padding-top:0px; padding-bottom:0px;">-</td>
                                </tr>
                                <tr style="padding-top:0px; padding-bottom:0px;">
                                    <td style="padding-top:0px; padding-bottom:0px;">Rent</td>
                                    <td style="padding-top:0px; padding-bottom:0px;">{{$rent_sum}}</td>
                                    <td style="padding-top:0px; padding-bottom:0px;">-</td>
                                </tr>
                                
                                <tr style="padding-top:0px; padding-bottom:0px;">
                                    <td style="padding-top:0px; padding-bottom:0px;">Others (Arrears & Bills)</td>
                                    <td style="padding-top:0px; padding-bottom:0px;">{{$others_sum}}</td>
                                    <td style="padding-top:0px; padding-bottom:0px;">-</td>
                                </tr>
                                <tr style="padding-top:0px; padding-bottom:0px;">
                                ...
                                <tr style="padding-top:0px; padding-bottom:0px;">
                                    ...
                                    <th colspan="2" style="padding-top:0px; padding-bottom:0px;">{{$balance}}</th>
                                </tr>
                            </tbody>
                          </table>
                    </div>
