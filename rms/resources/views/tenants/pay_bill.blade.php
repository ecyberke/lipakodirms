...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="{{route('tenant.payNowadmin', $deposit_data->id )}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                            <div id="tenantSelector" class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option value="{{$deposit_data->tenant_id}}" selected >{{$deposit_data->tenant_name }} | Ksh.{{number_format($deposit_data->deposit_amount)}}</option>
                            ...
                            <div class="col-md-6">
                                <label>Amount<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="{{$deposit_data->deposit_amount}}" readonly>
