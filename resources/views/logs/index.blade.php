...
<script>
    $(function () {
        $('#apartment-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '{!! route('api.apartments.logs') !!}',
            "order": [[ 3, "desc" ]],
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
                    { data: 'operation', name: 'operation' },
...
<script>
    $(function () {
        $('#services-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '{!! route('api.servicerequests.logs') !!}',
            "order": [[ 3, "desc" ]],
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
                    { data: 'operation', name: 'operation' },
