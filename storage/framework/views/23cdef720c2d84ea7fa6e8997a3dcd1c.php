...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
        <form action="<?php echo e(route('report.occupancy_expense_report')); ?>" method="get">
            <?php echo csrf_field(); ?>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <th><?php echo e($entry['serviceRequest']['house']['house_no']); ?></th>
                                 <th>
                                 <?php echo e($entry['serviceRequest']['service_type']); ?>

                                 </th>
                                  <th>
                                 <?php echo e($entry['serviceRequest']['affected_area']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/occupancy.blade.php ENDPATH**/ ?>