						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Property Maintenance Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
        <form action="{{route('report.occupancy_expense_report')}}" method="get">
            @csrf
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <th>{{$entry['serviceRequest']['house']['house_no']}}</th>
                                 <th>
                                 {{ $entry['serviceRequest']['service_type']}}
                                 </th>
                                  <th>
                                 {{$entry['serviceRequest']['affected_area'] }}
                                 </th>
