					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a href="{{ route('bill.create') }}" class="slide-item"> Add Bill</a></li>
								...
								<li><a href="{{ route('bill.payments') }}" class="slide-item">List Payments</a></li>
								<li><a href="{{ route('bill.paymentlist') }}" class="slide-item">Approve Payments</a></li>@endif
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="{{ route('houseviewing.create') }}" class="slide-item"> Add Prospective Tenant</a></li>
								<li><a href="{{ route('houseviewing.list') }}" class="slide-item"> List Prospective Tenant</a></li>
								<li><a href="{{ route('houseviewing.assign_room') }}" class="slide-item"> Assign Prospective Tenant House</a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<!--<li><a href="{{ route('report.houses_reports') }}" class="slide-item"> More Reports</a></li>-->
