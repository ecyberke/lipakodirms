...
@section('content')
    ...
    <div class="form-group">
        <label>Name *</label>
        <input type="text" name="name" value="{{ $serviceProvider->name }}" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Email</label>
        <input type="email" name="email" value="{{ $serviceProvider->email }}" class="form-control">
    </div>
    <div class="form-group">
        <label>Phone</label>
        <input type="text" name="phone" value="{{ $serviceProvider->phone }}" class="form-control">
    </div>
    <div class="form-group">
        <label>Address</label>
        <textarea name="address" class="form-control">{{ $serviceProvider->address }}</textarea>
    </div>
