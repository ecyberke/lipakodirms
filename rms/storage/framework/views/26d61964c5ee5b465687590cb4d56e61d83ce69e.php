				...
				<div class="app-sidebar app-sidebar2">
					<div class="app-sidebar__logo">
						<a class="header-brand" href="<?php echo e(url('/' . $page='index')); ?>">
							<img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" style= "width:100px; height:60px;" class="header-brand-img desktop-lgo"  alt="LIA">
							<img src="<?php echo e(URL::asset('assets/images/les.png')); ?>" style= "width:100px; height:60px;"  class="header-brand-img dark-logo" alt="LIA">
...
<!--aside closed-->
<?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/layouts/side-menu.blade.php ENDPATH**/ ?>