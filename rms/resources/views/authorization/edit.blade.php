                        ...
                        <div class="card-body">
                         ...
                         <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <label >User Level </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2-show-search" name="is_admin">
                                            <option value="0" {{ $user->is_admin===0 ? 'selected' : '' }} >Agent</option>
                                            <option value="1" {{ $user->is_admin===1 ? 'selected' : '' }} >Office Manager</option>
                                ...
                                <!--            <option value="0" {{ $user->authorize_payment===0 ? 'selected' : '' }} >No</option>-->
                                <!--            <option value="1" {{ $user->authorize_payment===1 ? 'selected' : '' }} >Yes</option>-->
                                <!--        </select>-->
                                <!--    </div>-->
