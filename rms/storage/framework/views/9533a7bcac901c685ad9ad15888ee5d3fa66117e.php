		...
		<div class="page relative">
			<div class="page-content">
				<div class="container text-center">
					...
					<p class="h5 font-weight-normal mb-4 leading-normal">Sorry! We are currently making updates to critical sections in the system</p>
					<div class="row">
						<div class="col-md-6 d-block mx-auto mb-4">
							<div class="row">
								...
								<div class="col col-auto">
									<div class="fs-18 font-weight-bold">40%</div>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="progress-wrapper mb-5 col-md-6 d-block mx-auto">
							<div class="progress progress-md">
								<div class="progress-bar-striped progress-bar-animated bg-primary" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"></div>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/eric/rms/resources/views/coming.blade.php ENDPATH**/ ?>