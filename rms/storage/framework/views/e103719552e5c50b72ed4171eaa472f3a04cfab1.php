                                 ...
                                 <div class="col-sm-4">
                                    <label >Reference Number <span class="text-danger"> *</span></label>
                                        ...
                                        <input class="form-control" type="text" id="example-text-input" name="reference_no"
                                             value="<?php echo e($apartment->reference_no); ?>">
                                  ...
                                  <div class="col-sm-4">
                                        <label >Property
                                            ...
                                            <select class="form-control select2-show-search" style="width: 100%" name="landlord_id">
                                                ...
                                                <option value="<?php echo e($apartment->landlord_id); ?>"><?php echo e($apartment->landlord->full_name); ?></option>
                                    ...
                                    <div class="col-sm-8">
                                     ...
                                     <div class="col-sm-4">
                                        ...
                                        <?php else: ?>
                                           ...
                                           <label for="active">Activate</label><br>
                                           <input type="radio" id="Deactive" name="active" value="0" checked>
                                           <label for="deactivate">Deactivate</label>
                                           <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/apartments/edit.blade.php ENDPATH**/ ?>