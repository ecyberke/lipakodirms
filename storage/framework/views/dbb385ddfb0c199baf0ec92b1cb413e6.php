									...
									<div class="card-group mb-0">
										<div class="card p-4 page-content">
											<div class="card-body page-single-content">
												<div class="w-100">
												<div class="">
													<h1 class="mb-2">Tenant Login</h1>
													<p class="text-muted">Tenant Portal — Sign in with your account number</p>
												</div>
												...
												<form method="POST" action="<?php echo e(route('tenant.login.post')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                            name="account_number" value="<?php echo e(old('account_number')); ?>" required autocomplete="off" autofocus placeholder="e.g. LKT00001" style="width:80%;text-transform:uppercase;">
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/tenant/auth/login.blade.php ENDPATH**/ ?>