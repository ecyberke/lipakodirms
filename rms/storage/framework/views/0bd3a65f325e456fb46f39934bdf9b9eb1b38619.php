...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							 <form action="<?php echo e(route('tenant.deposit_refund_store', $deposit_data->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-sm-12" >
                                        <div class="form-group">
                                            ...
                                            value="<?php if($deposit_data->tenant_name != null): ?>
                                            <?php echo e($deposit_data->tenant_name); ?>

                                            <?php else: ?> 
                                          
                                           <?php echo e($deposit_data->tenant->full_name); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php echo e($deposit_data->apartment->name); ?>" readonly>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php echo e($deposit_data->house_name); ?>" readonly>
                       ...
                       <input class="form-control " type="" name="deposit_invoice_id"  value="<?php echo e($deposit_data->id); ?>" hidden >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/tenants/deposit_refund.blade.php ENDPATH**/ ?>