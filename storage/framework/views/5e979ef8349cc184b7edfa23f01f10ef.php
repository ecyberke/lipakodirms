						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Tenant Balances</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
      <form action="<?php echo e(route('report.apartmentReportGenerate')); ?>" method="get">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <label >Select Property <span class="text-danger">*</span></label>
                                ...
                                <input hidden value="tenant_balances" type="text" name="type"/>
                            </div>
                        </div><br>
                        <!--<div class="row">-->
                        <!--    <div class="col-sm-6">-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/tenant_balance.blade.php ENDPATH**/ ?>