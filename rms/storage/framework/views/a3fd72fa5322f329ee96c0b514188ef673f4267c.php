						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-8 col-xl-9">
								<div class="card">
									...
									<div class="card-body">
										<div class="email-media">
											<div class="mt-0 d-sm-flex">
												<!--<img class="mr-2 rounded-circle avatar avatar-lg" src="<?php echo e(URL::asset('assets/images/users/2.jpg')); ?>" alt="avatar">-->
									...
									<a class="btn btn-primary mt-1 mb-1" href="/chat/<?php echo e($emails->id); ?>/email-read-reply"><i class="fa fa-reply"></i> Reply</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/chats/email-read.blade.php ENDPATH**/ ?>