<!--app header-->
							...
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="#">
										...
										<img src="<?php echo e(URL::asset('assets/images/brand/favicon.png')); ?>" class="header-brand-img mobile-logo" alt="Dashtic logo">
										<img src="<?php echo e(URL::asset('assets/images/brand/favicon1.png')); ?>" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
									</a>
									...
									<div class="d-flex order-lg-2 ml-auto">
										...
										<div class="dropdown profile-dropdown">
											<a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
												<span>
													<img src="<?php echo e(URL::asset('assets/images/users/16.jpg')); ?>" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
						...
						<!--/app header-->
<?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/layouts/header.blade.php ENDPATH**/ ?>