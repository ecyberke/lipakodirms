										...
										<div class="email-media">
											<div class="mt-0 d-sm-flex">
												...
												<div class="media-body pt-0">
													...
													<div class="media-title text-dark font-weight-semibold mt-1">To: {{$show->name}} <span class="text-muted font-weight-semibold">( {{$show->email}} )</span></div>
													<small class="mb-0">From: {{ Auth::user()->name}} - {{ Auth::user()->email}}</small>
