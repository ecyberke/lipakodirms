						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">All Houses in a Period</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <div class="cal-icon">
                                 ...
                                 <input hidden value="all_houses" type="text" name="selected_report"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/all_houses.blade.php ENDPATH**/ ?>