						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Add Tenant/Company</li></li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
                                ...
                                <div class="col-sm-4" >
                                 ...
                                 <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="company_phone" pattern=".{12,}"    title="Phone number must begin with 254 and contain 12 characters"
                                            maxlength="12">
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="kin_id" value="<?php echo e(old('kin_id')); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/tenants/register.blade.php ENDPATH**/ ?>