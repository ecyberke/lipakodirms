                    ...
                    <table id="landlords-table" class="table table-striped dt-responsive nowrap"
                        ...
                        <thead>
                            <tr>
                               ...
                               <th>Owns</th>
                               <th>Next of Kin ID/PP Number</th>
    ...
    $(function () {
        $('#landlords-table').DataTable({
            ...
            columns: [
                ...
                { data: 'id', name: 'id' },
                { data: 'landlordid_number', name: 'landlordid_number' },
                { data: 'email', name: 'email' },
                //{ data: 'phone_no', name: 'phone_no', orderable: false },
                { data: 'count', name: 'count', orderable: false },
                { data: 'emergency_id', name: 'emergency_id', orderable: false },
         ...
         $(document).on('submit','.delete-landlord',function(event){
            return confirm('Are you sure you want to temporarily delete this Owner ? You have to permanently delete to reuse his/her details. All information associated with the tenant will also be deleted and some may never be recovered. Click OK if you are very sure of your action.');            
        });
    });
</script>
<!-- Data tables -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/landlords/all.blade.php ENDPATH**/ ?>