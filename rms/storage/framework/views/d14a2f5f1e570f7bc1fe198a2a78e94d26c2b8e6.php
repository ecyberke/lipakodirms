						...
						<div class="row">
							...
							<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
										...
										<a href="<?php echo e(url('/chat/' . $page='email-sent')); ?>" class="list-group-item list-group-item-action d-flex align-items-center active">
...
<script>
    $(function () {
        $('#bill-table').DataTable({
            ...
            serverSide: true,
             "pageLength": 10,
            ajax: '<?php echo route('api.chats.email-sent'); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/chats/email-sent.blade.php ENDPATH**/ ?>