												...
												<div class="row align-items-center">
													...
													<div class="col-sm-10">
														<select class="form-control select2-show-search" style="width: 100%"  name="receiver_id">
                                                          ...
                                                          @forelse ($user as $test)
                                                         <option value="{{$test->id}}">{{$test->email}} - {{$test->name}} </option>
                                                    @empty
