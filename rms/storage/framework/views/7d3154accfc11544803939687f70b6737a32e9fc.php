						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Important Emails</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
							...
							<div class="col-md-12 col-lg-4 col-xl-3">
								<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
										...
										<a href="<?php echo e(url('/chat/' . $page='email-important')); ?>" class="list-group-item list-group-item-action d-flex align-items-center active">
...
<script>
    $(function () {
        $('#bill-table').DataTable({
            ...
            serverSide: true,
             "pageLength": 10,
            ajax: '<?php echo route('api.chats.email-important'); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/chats/email-important.blade.php ENDPATH**/ ?>