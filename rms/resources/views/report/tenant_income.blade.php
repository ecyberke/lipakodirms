...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="{{route('report.tenant_income_report')}}" method="get" enctype="multipart/form-data">
            @csrf
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                           ...
                           <p><strong>Total Expected:</strong> <span>Kshs. {{number_format($totals['total_payable'])}}</span></p>
                    ...
                    <div class="row table-responsive   ">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">-->
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th>{{$entry['property_name']}}</th>
                                <th>{{$entry['house_name']}}</th>
                                <th>{{$entry['tenant_name']}}</th>
