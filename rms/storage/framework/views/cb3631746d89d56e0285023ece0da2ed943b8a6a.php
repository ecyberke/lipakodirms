...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							 <form action="<?php echo e(route('p_tenant.allocate')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <label >Select Property <span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%" id="apartment_id" name="apartment">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                            <label >Rent Deposit Amount<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            ...
                            <label>Placement Date <span
                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-12">
                                    <h4 class="text-muted m-b-30 font-14">UPDATE TENANT DETAILS
                                    </h4>
                                </div><hr>
                            <!-- end row -->
                            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/houseviewing/asign_room.blade.php ENDPATH**/ ?>