						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Missing Invoices</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							 <form action="{{ route('tenant.missing_invoice', $house->id)}}" method="post" class="card">
        @csrf
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                            <label >Select Month Missing <span class="text-danger">*</span></label>
                          
                            
                                <select class="form-control select2-show-search" style="width: 100%" name="mths">
                            ...
                            <label >Select Year <span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%" id="apartment_id" name="yr">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-8">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Generate Missing Invoice</button>
                            </div>
