						...
						<div class="row">
							...
							<div class="col-lg-8 col-xl-9">
								<div class="row">
									...
									<div class="col mb-4">
									    <form action="{{ route('tenant.contract')}}" method="post" enctype="multipart/form-data">
                            @csrf
									     <div class="">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Change of Management-Lesa-1.pdf') }}"><i class="fe fe-eye mr-2"></i>View</a>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Change of Management-Lesa-2.pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
															<!--<a class="dropdown-item" href="#"><i class="fe fe-share mr-2"></i> Share</a>-->
															<!--<a class="dropdown-item" href="#"><i class="fe fe-download mr-2"></i> Download</a>-->
															<!--<form method="POST" action="{{ url('filemanager/delete_file/Change of Management-Lesa-1.pdf') }}">-->
               <!--                                     @csrf-->
               ...
               <!--                                 </form>-->
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Change of Management-Owner.pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Company Profile Current.pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Demand notice current.pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Late Rent Payment Notice current.pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Lesa-Letterhead-Print (pdf).pdf') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
														<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/Notice on Cleanliness.docx') }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
                                ...
                                <div class="col-md-12">
                                    <div style="display: flex; overflow: auto;">
                                        ...
                                        @foreach ($recent_files as $number) 
                                        ...
                                        <div class="card m-2" style="max-width:15em; min-width:14em;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="POST" action="{{ url('filemanager/delete_file/'.$number['id'].'/'.$num) }}">
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger btn-sm">Delete</button>
									...
									<div class="col-xl-3 col-md-4 col-sm-6">
										...
										<div class="card border p-0 shadow-none">
											...
											<div class="d-flex align-items-center px-4 pt-4">
												...
												<div class="float-right ml-auto">
													<div class="btn-group ml-3 mb-0">
														<a href="#" class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="{{asset('rms/storage/app/filemanager/'.$num) }}"><i class="fe fe-eye mr-2"></i> View</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card-body pt-0 text-center">
												...
												<h6 class="mb-1 font-weight-semibold mt-4">{{$num}}</h6>
