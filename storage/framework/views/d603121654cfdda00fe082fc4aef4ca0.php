						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									<li class="breadcrumb-item"><a href="<?php echo e(route('tenant.all')); ?>">Tenants</a></li>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-20 pt-2">
                        <form action="<?php echo e(route('tenant.update', $tenant->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                               ...
                               <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select  class="form-control select2-show-search" id="type" style="width: 100%" name="type_select">
                                     <?php if($tenant->type_select == null): ?>
                                        <option selected disabled>-----Select-----</option>
                                     <?php else: ?>
                                      <option value="<?php echo e($tenant->type_select); ?>"><?php echo e($tenant->type_select); ?></option>
                                     <?php endif; ?>
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        value="<?php echo e($tenant->full_name); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        value="<?php echo e($tenant->person); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="id_number" value="<?php echo e($tenant->id_number); ?>"  id="passport">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <select class="form-control select2-show-search" name="occupation">
                                            <option><?php echo e($tenant->occupation); ?></option>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Names</label>
                                <div>
                                    <input type="text" class="form-control" name="emergency_person" value="<?php echo e($tenant->emergency_person); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="tel" class="form-control" name="emergency_number" value="<?php echo e($tenant->emergency_number); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="kin_id" value="<?php echo e($tenant->kin_id); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="text" class="form-control" name="relationship" value="<?php echo e($tenant->relationship); ?>">
                                </div>
                            </div>
                        </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/tenants/edt.blade.php ENDPATH**/ ?>