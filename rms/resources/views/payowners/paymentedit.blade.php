...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="{{ route('payowner.payNowUpdate', $managerpayment->id)}}" method="post" class="card">
        @csrf
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div>
                                      ...
                                      <input class="form-control " type="text" id="example-text-input" name="bill_type"
                                        value="{{$managerpayment->bill_type}}" readonly>
                        ...
                        <div class="row">
                            @if ($managerpayment->bill_type === 'property')
                            <div  class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="MSISDN">
                                    ...
                                    <option value="{{$managerpayment->MSISDN}}">{{$managerpayment->full_name}}</option>
                                  </select>
                                </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                        ...
                                        value="{{$managerpayment->MSISDN}} " readonly>
                            ...
                            <div class="col-md-6">
                                <label>Transaction Code<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="{{$managerpayment->TransID}}" readonly>
                            ...
                            <div class="col-md-6">
                                <label for="example-text-input">Payment Method <span class="text-danger">*</span></label>
                                 <input class="form-control " type="text" id="example-text-input" name="payment_type"
                                        value="{{$managerpayment->TransactionType}}" readonly>
                            ...
                            <div class="col-md-6">
                                <label>Amount<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="{{$managerpayment->TransAmount}}" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="payment_date"
                                                value="{{$managerpayment->payment_date}}" readonly>
                                        </div>
                                    </div>
