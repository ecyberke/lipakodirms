                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <select class="js-example-basic-single js-states form-control" name="rent_period" >
                                        <option selected value="<?php echo e($house->rent_const); ?>"><?php echo e($house->rent_const); ?> Month(s)</option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/houses/edit.blade.php ENDPATH**/ ?>