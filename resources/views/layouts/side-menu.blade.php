                                ...
                                <div class="app-sidebar app-sidebar2">
                                        <div class="app-sidebar__logo">
                                                <a class="header-brand" href="{{ route('home') }}">
                                                        ...
                                                        <img src="{{URL::asset('assets/images/lipakodi_main_logo.png')}}" class="header-brand-img darkmobile-logo" alt="LIA">
                                                </a>
                                        </div>
                                </div>
                                <aside class="app-sidebar app-sidebar3">
                                        <ul class="side-menu">
                                            <li class="menutitles">Main</li>
                                                ...
                                                {{-- ============================================================ --}}
                                                {{-- ADMIN SECTION (Expenses to be renamed Finance in future) --}}
                                                {{-- ============================================================ --}}
                                                <li class="menutitles">Admin</li>
                                                {{-- Expenses: visible to all org types (agency & individual) --}}
                                                <li class="slide">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('bill.create') }}" class="slide-item">Add Expense</a></li>
                                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                                <li><a href="{{ route('expenses.list') }}" class="slide-item">List Expenses</a></li>
                                                                <li><a href="{{ route('bill.approve') }}" class="slide-item">Approve Expenses</a></li>
                                                                @endif
                                                        </ul>
                                                </li>
                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                <li class="slide">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('manualinvoice.pay') }}" class="slide-item">Pay Invoice</a></li>
                                                                <li><a href="{{ route('manualinvoice.list') }}" class="slide-item"> List Invoices</a></li>
                                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                                <li><a href="{{ route('manualinvoice.payments') }}" class="slide-item">List Payments</a></li>
                                                                <li><a href="{{ route('manualinvoice.paymentlist') }}" class="slide-item">Approve Payments</a></li>
                                                                @endif
                                                        </ul>
                                                </li>
                                                @endif
                                                ...
                                                <li class="slide">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('servicerequests.create') }}" class="slide-item"> Add Request</a></li>
                                                                <li><a href="{{ route('servicerequests.index') }}" class="slide-item"> List Requests</a></li>
                                                                <li><a href="{{ route('bill.property_bills') }}" class="slide-item"> Add Property Bill</a></li>
                                                                <li><a href="{{ route('payowners.list') }}" class="slide-item"> List Bills</a></li>
                                                                <li><a href="{{ route('billscategories.create') }}" class="slide-item"> Add Bill Categories</a></li>
                                                        </ul>
                                                </li>
                                                ...
                                                <li class="slide">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('service-providers.create') }}" class="slide-item"> Add Service Provider</a></li>
                                                                <li><a href="{{ route('service-providers.index') }}" class="slide-item"> List Service Providers</a></li>
                                                        </ul>
                                                </li>

                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('sms.custom') }}">
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('email.inbox') }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="side-menu__icon"><path d="M17.388,4.751H2.613c-0.213,0-0.389,0.175-0.389,0.389v9.72c0,0.216,0.175,0.389,0.389,0.389h14.775c0.214,0,0.389-0.173,0.389-0.389v-9.72C17.776,4.926,17.602,4.751,17.388,4.751 M16.448,5.53L10,11.984L3.552,5.53H16.448zM3.002,6.081l3.921,3.925l-3.921,3.925V6.081z M3.56,14.471l3.914-3.916l2.253,2.253c0.153,0.153,0.395,0.153,0.548,0l2.253-2.253l3.913,3.916H3.56z M16.999,13.931l-3.921-3.925l3.921-3.925V13.931z"></path></svg>
                                                        <span class="side-menu__label">Internal Email</span>
                                                        </a>
                                                </li>

                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('softdeletes.index')}}">
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{route('tenant.create')}}">
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{route('tenant.assign_room')}}">
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('house.occupied')}}">
                                                ...
                                                {{-- ============================================================ --}}
                                                {{-- PROPERTY OWNERS — Agency only --}}
                                                {{-- ============================================================ --}}
                                                @if($currentOrganization?->isAgency())
                                                <li class="menutitles">Property Owners</li>
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{route('landlord.create')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M13.388,9.624h-3.011v-3.01c0-0.208-0.168-0.377-0.376-0.377S9.624,6.405,9.624,6.613v3.01H6.613c-0.208,0-0.376,0.168-0.376,0.376s0.168,0.376,0.376,0.376h3.011v3.01c0,0.208,0.168,0.378,0.376,0.378s0.376-0.17,0.376-0.378v-3.01h3.011c0.207,0,0.377-0.168,0.377-0.376S13.595,9.624,13.388,9.624z M10,1.344c-4.781,0-8.656,3.875-8.656,8.656c0,4.781,3.875,8.656,8.656,8.656c4.781,0,8.656-3.875,8.656-8.656C18.656,5.219,14.781,1.344,10,1.344z M10,17.903c-4.365,0-7.904-3.538-7.904-7.903S5.635,2.096,10,2.096S17.903,5.635,17.903,10S14.365,17.903,10,17.903z"></path></svg>
                                                        <span class="side-menu__label">Add Owner</span></a>
                                                </li>
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('landlord.index')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M2.25,12.584c-0.713,0-1.292,0.578-1.292,1.291s0.579,1.291,1.292,1.291c0.713,0,1.292-0.578,1.292-1.291S2.963,12.584,2.25,12.584z M2.25,14.307c-0.238,0-0.43-0.193-0.43-0.432s0.192-0.432,0.43-0.432c0.238,0,0.431,0.193,0.431,0.432S2.488,14.307,2.25,14.307z M5.694,6.555H18.61c0.237,0,0.431-0.191,0.431-0.43s-0.193-0.431-0.431-0.431H5.694c-0.238,0-0.43,0.192-0.43,0.431S5.457,6.555,5.694,6.555z M2.25,8.708c-0.713,0-1.292,0.578-1.292,1.291c0,0.715,0.579,1.292,1.292,1.292c0.713,0,1.292-0.577,1.292-1.292C3.542,9.287,2.963,8.708,2.25,8.708z M2.25,10.43c-0.238,0-0.43-0.192-0.43-0.431c0-0.237,0.192-0.43,0.43-0.43c0.238,0,0.431,0.192,0.431,0.43C2.681,10.238,2.488,10.43,2.25,10.43z M18.61,9.57H5.694c-0.238,0-0.43,0.192-0.43,0.43c0,0.238,0.192,0.431,0.43,0.431H18.61c0.237,0,0.431-0.192,0.431-0.431C19.041,9.762,18.848,9.57,18.61,9.57z M18.61,13.443H5.694c-0.238,0-0.43,0.193-0.43,0.432s0.192,0.432,0.43,0.432H18.61c0.237,0,0.431-0.193,0.431-0.432S18.848,13.443,18.61,13.443z M2.25,4.833c-0.713,0-1.292,0.578-1.292,1.292c0,0.713,0.579,1.291,1.292,1.291c0.713,0,1.292-0.578,1.292-1.291C3.542,5.412,2.963,4.833,2.25,4.833z M2.25,6.555c-0.238,0-0.43-0.191-0.43-0.43s0.192-0.431,0.43-0.431c0.238,0,0.431,0.192,0.431,0.431S2.488,6.555,2.25,6.555z"></path></svg>
                                                        <span class="side-menu__label">List Owners</span></a>
                                                </li>
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('bill.remittence')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M2.25,12.584c-0.713,0-1.292,0.578-1.292,1.291s0.579,1.291,1.292,1.291c0.713,0,1.292-0.578,1.292-1.
.579,1.291,1.292,1.291c0.713,0,1.292-0.578,1.292-1.291C3.542,5.412,2.963,4.833,2.25,4.833z M2.25,6.555c-0.238,0-0.43-0.191-0.43-0.43s0.192-0.431,0.43-0.431c0.238,0,0.431,0.192,0.431,0.431S2.488,6.555,2.25,6.555z"></path></svg>
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('apartment.create')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M13.388,9.624h-3.011v-3.01c0-0.208-0.168-0.377-0.376-0.377S9.624,6.405,9.624,6.613v3.01H6.613c-0.208,0-0.376,0.168-0.376,0.376s0.168,0.376,0.376,0.376h3.011v3.01c0,0.208,0.168,0.378,0.376,0.378s0.376-0.17,0.376-0.378v-3.01h3.011c0.207,0,0.377-0.168,0.377-0.376S13.595,9.624,13.388,9.624z M10,1.344c-4.781,0-8.656,3.875-8.656,8.656c0,4.781,3.875,8.656,8.656,8.656c4.781,0,8.656-3.875,8.656-8.656C18.656,5.219,14.781,1.344,10,1.344z M10,17.903c-4.365,0-7.904-3.538-7.904-7.903S5.635,2.096,10,2.096S17.903,5.635,17.903,10S14.365,17.903,10,17.903z"></path></svg>
                                                        <span class="side-menu__label">Add Property</span></a>
                                                </li>
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('apartment.add_unit')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16.469,8.924l-2.414,2.413c-0.156,0.156-0.408,0.156-0.564,0c-0.156-0.155-0.156-0.408,0-0.563l2.414-2.414c1.175-1.175,1.175-3.087,0-4.262c-0.57-0.569-1.326-0.883-2.132-0.883s-1.562,0.313-2.132,0.883L9.227,6.511c-1.175,1.175-1.175,3.087,0,4.263c0.288,0.288,0.624,0.511,0.997,0.662c0.204,0.083,0.303,0.315,0.22,0.52c-0.171,0.422-0.643,0.17-0.52,0.22c-0.473-0.191-0.898-0.474-1.262-0.838c-1.487-1.485-1.487-3.904,0-5.391l2.414-2.413c0.72-0.72,1.678-1.117,2.696-1.117s1.976,0.396,2.696,1.117C17.955,5.02,17.955,7.438,16.469,8.924 M10.076,7.825c-0.205-0.083-0.437,0.016-0.52,0.22c-0.083,0.205,0.016,0.437,0.22,0.52c0.374,0.151,0.709,0.374,0.997,0.662c1.176,1.176,1.176,3.088,0,4.263l-2.414,2.413c-0.569,0.569-1.326,0.883-2.131,0.883s-1.562-0.313-2.132-0.883c-1.175-1.175-1.175-3.087,0-4.262L6.51,9.227c0.156-0.155,0.156-0.408,0-0.564c-0.156-0.156-0.408-0.156-0.564,0l-2.414,2.414c-1.487,1.485-1.487,3.904,0,5.391c0.72,0.72,1.678,1.116,2.696,1.116s1.976-0.396,2.696-1.116l2.414-2.413c1.487-1.486,1.487-3.905,0-5.392C10.974,8.298,10.55,8.017,10.076,7.825"></path></svg>
                                                        <span class="side-menu__label">Add House</span></a>
                                                </li>
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{route('apartment.list')}}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M2.25,12.584c-0.713,0-1.292,0.578-1.292,1.291s0.579,1.291,1.292,1.291c0.713,0,1.292-0.578,1.292-1.

                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('tenant.all') }}" class="slide-item">Tenant Details</a></li>
                                                                <li><a href="{{ route('report.tenantform') }}" class="slide-item">Get Statement</a></li>
                                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                                <li><a href="{{ route('report.tenant_balance') }}" class="slide-item">Tenant Balances</a></li>
                                                                <li><a href="{{ route('report.tenant_income') }}" class="slide-item">All Tenant Payments</a></li>
                                                                @endif
                                                        </ul>
                                                </li>
                                                ...
                                                <li class="slide">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('report.landlordform') }}" class="slide-item">Get Statement</a></li>
                                                                <li><a href="{{ route('report.property_income_expense') }}" class="slide-item">Properties Income Expense</a></li>
                                                                <li><a href="{{ route('report.occupancy_expense') }}" class="slide-item">Maintenance</a></li>
                                                                <li><a href="{{ route('report.property_status') }}" class="slide-item">Property Status</a></li>
                                                                <li><a href="{{ route('report.rent') }}" class="slide-item">Rent Report</a></li>
                                                                <li><a href="{{ route('report.prop_income') }}" class="slide-item">All Properties Income</a></li>
                                                                <li><a href="{{ route('report.vacant_report') }}" class="slide-item">Vacant Houses</a></li>
                                                                <li><a href="{{ route('report.occupied_report') }}" class="slide-item">Occupied Houses</a></li>
                                                                <li><a href="{{ route('report.notice_report') }}" class="slide-item">Houses on Notice</a></li>
                                                                <li><a href="{{ route('report.all_properties') }}" class="slide-item">All Properties</a></li>
                                                                @if($currentOrganization?->isAgency())
                                                                <li><a href="{{ route('report.all_owners') }}" class="slide-item">All Owners</a></li>
                                                                @endif
                                                                <li><a href="{{ route('report.all_houses') }}" class="slide-item">All Houses</a></li>
                                                        </ul>
                                                </li>
                                                @endif

                                                {{-- Agency report — agency only --}}
                                                @if($currentOrganization?->isAgency())
                                                @if (Auth::user()->is_admin==2 || Auth::user()->is_admin==1)
                                                <li class="slide">
                                                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                                                        ...
                                                        <ul class="slide-menu">
                                                                <li><a href="{{ route('report.agencyform') }}" class="slide-item">Get Statement</a></li>
                                                                <li><a href="{{ route('report.agency_status') }}" class="slide-item">Agency Status</a></li>
                                                                <li><a href="{{ route('report.agency_income_expense') }}" class="slide-item">Agency Income Expense</a></li>
                                                        </ul>
                                                </li>
                                                @endif
                                                @endif
                                                ...
                                                <li class="slide">
                                                        <a class="side-menu__item" href="{{ route('admin.create') }}">
                                                        <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path fill="none" d="M13.388,9.624h-3.011v-3.01c0-0.208-0.168-0.377-0.376-0.377S9.624,6.405,9.624,6.613v3.01H6.613c-0.208,0-0.376,0.168-0.376,0.376s0.168,0.376,0.376,0.376h3.011v3.01c0,0.208,0.168,0.378,0.376,0.378s0.376-0.17,0.376-0.378v-3.01h3.011c0.207,0,0.377-0.168,0.377-0.376S13.595,9.624,13.388,9.624z M10,1.344c-4.781,0-8.656,3.875-8.656,8.656c0,4.781,3.875,8.656,8.656,8.656c4.781,0,8.656-3.875,8.656-8.656C18.656,5.219,14.781,1.344,10,1.344z M10,17.903c-4.365,0-7.904-3.538-7.904-7.903S5.635,2.096,10,2.096S17.903,5.635,17.903,10S14.365,17.903,10,17.903z"></path></svg>
