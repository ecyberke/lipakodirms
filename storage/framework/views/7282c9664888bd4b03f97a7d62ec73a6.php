...
<?php $__env->startSection('content'); ?>
	...
	<form method="POST" action="<?php echo e(route('servicerequests.store')); ?>" class="card">
    <?php echo csrf_field(); ?>
        <div class="row">
        ...
        <input type="hidden" name="approval" value="<?php echo e(Auth::user()->is_super ? '1' : '0'); ?>">
...
<script>
    ...
    $('#houses_select').change(function () {
        ...
        $.ajax({
            url: "<?php echo route('ajax.house.tenant'); ?>",
            method: 'POST',
            data: { 'id': id, '_token': token },
            success: function (data) {
                $('#house-rent').val('');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/servicerequests/create.blade.php ENDPATH**/ ?>