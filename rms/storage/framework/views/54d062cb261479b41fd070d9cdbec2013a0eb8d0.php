...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="<?php echo e(route('report.tenant_income_report')); ?>" method="get">
            <?php echo csrf_field(); ?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <p><strong>Total Payment:</strong> <span><?php echo e(number_format($total_paid_in)); ?></span></p>
                        </div> <!-- end col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/report/tenant_month_income.blade.php ENDPATH**/ ?>