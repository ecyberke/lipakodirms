...
<script>
    $(function () {
        $('#houses-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.houses.trashed'); ?>',
...
<script>
    $(function () {
        $('#invoices-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.invoices.trashed'); ?>',
...
<script>
    $(function () {
        $('#landlord-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.landlord.trashed'); ?>',
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
...
<script>
    $(function () {
        $('#apartment-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.apartments.trashed'); ?>',
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
                    { data: 'name', name: 'name' },
                    { data: 'type', name: 'type' },
...
<script>
    $(function () {
        $('#tenants-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.tenants.trashed'); ?>',
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
                    { data: 'full_name', name: 'full_name' },
...
<script>
    $(function () {
        $('#user-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.systemuser.trashed'); ?>',
...
<script>
    $(function () {
        $('#bill-table').DataTable({
            ...
            serverSide: true,
            "pageLength": 25,
            ajax: '<?php echo route('api.bills.trashed'); ?>',
            columns: [ 
              { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false , searchable:false}, 
                    { data: 'type', name: 'type' },
                    { data: 'description', name: 'description' },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/softdeletes/index.blade.php ENDPATH**/ ?>