						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Agency Status Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="{{route('report.agency_status_report')}}" method="get">
            @csrf
                        ...
                        <table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-right">{{number_format($entry['carryforward'])}}</td>
                              ...
                              <tr>
                                ...
                                <th class="text-right">{{number_format($totals['total_carryforward'])}}</th>
                                <td class="text-right">-</td>
