						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">All Owners in a Period</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
    <form action="<?php echo e(route('report.houses_reports_generate')); ?>" method="get">
        <?php echo csrf_field(); ?>
                ...
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <input hidden value="all_property_owners" type="text" name="selected_report"/>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/all_owners.blade.php ENDPATH**/ ?>