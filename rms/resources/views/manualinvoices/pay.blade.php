...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							   @if (Auth::user()->is_admin==1)
							     <form action="{{ route('invoice.payNow')}}" method="post" class="card">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div id="invoiceSelector" class="col-md-6">
                                ...
                                <option value="{{$inv->id}}">Type: {{ $inv->type}} Tenant: {{$inv->tenant_id}} Balance: {{$inv->balance}}</option>
                                        @empty
    ...
    @else
     <form action="{{ route('invoice.payNowadmin')}}" method="post" class="card">
        @csrf
