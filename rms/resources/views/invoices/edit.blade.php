						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="{{ route('home')}}" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									<li class="breadcrumb-item"><a href="{{ route('manualinvoice.list') }}">Invoice</a></li>
...
@section('content')
	 ...
	 <form action="{{route('invoice.update', $invoice->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <select  class="js-example-basic-single select" style="width: 100%"  name="type">
                                    ...
                                    <option value="{{$invoice->type}}" selected>{{$invoice->type}}</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-8" >
                                        <div class="form-group">
                                            ...
                                            value="@if($invoice->tenant_name != null)
                                            {{$invoice->tenant_name}}
                                            @else 
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="{{$invoice->apartment->name}}" readonly>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="{{$invoice->house_name}}" readonly>
                                     ...
                                     <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="{{$invoice->tenant->account_number}}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="{{$invoice->deposit_paid}}" required>
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="{{$invoice->electricity_deposit_paid}}">
                                    ...
                                    <!--            value="{{$invoice->total_payable}}" required>-->
                                ...
                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <textarea name="description" class="form-control" rows="6"  >{{$invoice->description}}</textarea>
                                ...
                                <div class="col-sm-3" >
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            value="{{$invoice->electricity_bill}}">
