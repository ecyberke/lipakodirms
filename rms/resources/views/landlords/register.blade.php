                        ...
                        <div class="p-20">
                            ...
                            <form action="{{ route('landlord.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Surname Name <span class="text-danger">*</span> </label>
                                            <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="id"
                                                    value="{{old('id')}}" pattern=".{12,}"   required title="Phone number must begin with 254 and contain 12 characters" maxlength="12">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    ...
                                    {{-- <div class="col-sm-4">
                                        <div class="form-group">
                                            <label>Property Owner System Code: <span class="text-danger">*</span></label>
                                            <div>
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_id" value="{{old('emergency_id')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
