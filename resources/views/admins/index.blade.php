            ...
            <i class="fe fe-settings"></i> Setup Wizard
						...
						<div class="row">
							<div class="col-xl-12 col-md-12 col-lg-12">
								<div class="row">
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<h2 class="mb-1 font-weight-bold">{{$occupied_house}}</h2>
									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<h2 class="mb-1 font-weight-bold">{{$vacant_house}}</h2>
									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body"><a  href="{{route('tenant.all')}}" >
												...
												<h2 class="mb-1 font-weight-bold">{{ $tenants }}</h2>
									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body">
												...
												<h2 class="mb-1 font-weight-bold">{{ $apartments }}</h2>
											...
											<div class="card-body">
												<div class="row">
													<div class="col">
														...
														<h3 class="mb-0 font-weight-bold">Ksh.{{number_format($income_today)  }}</h3>
													</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col">
														...
														<h3 class="mb-0 font-weight-bold">Ksh.{{number_format($month_income)  }}</h3>
													</div>
													<div class="col col-auto">
														<div id="spark2"></div>
													</div>
						...
						<div class="row row-deck">
                                ...
                                <table class="table table-bordered  table-nowrap datatable" id="balance-table">
                                    ...
                                    <tbody>
                                       @forelse ($tenats as $objects)
                                        <tr>
                                            <td class="">{{ ($objects->full_name) }}</td>
                                            <td class="text-uppercase">{{ ($objects->phone) }}</td>
							...
							<div class="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <table class="table table-striped table-bordered text-nowrap" style="width:100%" >
                                    ...
                                    <tbody>
                                       @forelse ($servicerequest as $object)
                                        <tr>
                                            <td class="">@if($object->tenant_id == null) General Apartment Service @else{{ ($object->tenant->full_name) }} @endif</td>
                                            <td class="">{{ ($object->apartment->name) }}</td>
                                            <td class="text-uppercase">@if($object->house_id == null) General Apartment Service @else{{ ($object->house->house_no) }} @endif</td>
                                             <td class="">
                                             @if ($object->approval == 0)
                                   <span class="badge badge-info">PENDING</span>
                                    @elseif ($object->approval == 1)  <span class="badge badge-success">APPROVED</span>
                                   @elseif ($object->approval == 3)<span class="badge badge-secondary">AMEND</span>
                                   @else
                                   <span class="badge badge-danger">DECLINED</span>
                                   @endif</td>
                                   <td class="">
                                        <a href="{{route('servicerequests.show', $object->id)}}"> View</a>
                                    </td>
                                        </tr>
                                        @empty
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">{{ $tenants }}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="calendar"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #4e73df;">
					<a class="small text-white stretched-link" href="{{route('tenant.all')}}" >List Tenants</a>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">{{ $landlords }}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="dollar-sign"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #f6c23e;">
					<a class="small text-white stretched-link" href="{{route('landlord.index')}}">List Property Owners</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">{{ $apartments }}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="check-square"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #858796;">
					<a class="small text-white stretched-link" href="{{route('apartment.list')}}">List Properties</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">{{ $houses }}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="message-circle"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #36b9cc">
					<a class="small text-white stretched-link" href="{{route('house.list')}}">List All Houses</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
		<div class="col-xxl-3 col-lg-3">
			<div class="card text-white mb-4" style="background-color: #b4df4e;" >
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">Ksh.{{number_format($income_today)  }}
				...
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #b4df4e;">
					<a class="small text-white stretched-link" href="{{route('invoice.paid')}}" >List Paid Invoices</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">Ksh.{{number_format($month_income)  }}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="dollar-sign"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color:#e87c3e;">
					<a class="small text-white stretched-link" href="{{route('manualinvoice.payments')}}">List Payments</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">Ksh.{{number_format($bill_today)}}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="check-square"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #e83e8c">
					<a class="small text-white stretched-link" href="{{route('payowners.list')}}">List Bills</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
				...
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						<div class="mr-3">
							...
							<div class="text-lg font-weight-bold">Ksh.{{number_format($month_bill)}}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="message-circle"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #6f42c1">
					<a class="small text-white stretched-link" href="{{route('servicerequests.index')}}">List Service Requests</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
		<div class="col-xxl-3 col-lg-6">
			<div class="card bg-success text-white mb-4">
				...
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color:#1cc88a">
					<a class="small text-white stretched-link" href="{{route('house.occupied')}}">List Occupied Houses</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
			...
			<div class="card bg-danger text-white mb-4">
				<div class="card-body">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="text-lg font-weight-bold">{{$vacant_house}}</div>
						</div>
						<i class="feather-xl text-white-50" data-feather="message-circle"></i>
					</div>
				</div>
				<div class="card-footer d-flex align-items-center justify-content-between" style="background-color:#e74a3b">
					<a class="small text-white stretched-link" href="{{route('house.vacant')}}">List Vacant Houses</a>
					{{-- <div class="small text-white"><i class="fas fa-angle-right"></i></div> --}}
				</div>
			</div>
		</div>
