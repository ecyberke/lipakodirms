...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							 <form action="{{ route('tenant.updateallocateHouse',$house_tenants->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <label >Select Tenant <span class="text-danger">*</span></label>
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id" readonly>
                                    ...
                                    <option value="{{$house_tenants->tenant_id}}">{{$house_tenants->tenant->full_name}}</option>
                            ...
                            <div class="row">
                                ...
                                <label >Select House<span class="text-danger">*</span></label>
                                    ...
                                    <select class="form-control select2-show-search" style="width: 100%" name="house_id" id="houses_select">
                                        <option value="{{$house_tenants->house_id}}">{{$house_tenants->house->house_no}}</option>
                                ...
                                <label >Monthly
                                    ...
                                    <input class="form-control" type="text" id="house-rent" value="{{$house_tenants->house->rent->amount}}" readonly>
                                    </div>
                                </div>
                            </div><br>
                                ...
                                <div class="form-group">
                                    <div class="cal-icon">
                                        <input class="form-control" type="date" name="placement_date"
                                            value="{{$house_tenants->placement_date}}">
                                    </div>
                                </div>
