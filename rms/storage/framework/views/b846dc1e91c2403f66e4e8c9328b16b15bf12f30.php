						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Approve Payment</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="<?php echo e(route('payowner.payNowUpdate', $managerpayment->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div>
                                      ...
                                      <input class="form-control " type="text" id="example-text-input" name="bill_type"
                                        value="<?php echo e($managerpayment->bill_type); ?>" readonly>
                        ...
                        <div class="row">
                            <?php if($managerpayment->bill_type === 'property'): ?>
                            <div  class="col-md-6">
                                <label>Property <span class="text-danger">*</span></label>
                                
                                <div>
                                     <div class="form-group">
                                <select class="form-control select2-show-search" style="width: 100%" name="MSISDN">

                                    <option value="<?php echo e($managerpayment->MSISDN); ?>"><?php echo e($managerpayment->full_name); ?></option>
                                  </select>
                                </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                           <input class="form-control " type="text" id="example-text-input" name="MSISDN"
                                        value="<?php echo e($managerpayment->MSISDN); ?> " readonly>
                            ...
                            <div class="col-md-6">
                                <label>Transaction Code<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="<?php echo e($managerpayment->TransID); ?>" readonly>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label for="example-text-input">Payment Method <span class="text-danger">*</span></label>
                                 <input class="form-control " type="text" id="example-text-input" name="payment_type"
                                        value="<?php echo e($managerpayment->TransactionType); ?>" readonly>
                            ...
                            <div class="col-md-6">
                                <label>Amount<span class="text-danger">*</span></label>
                                    <div>
                                        ...
                                        value="<?php echo e($managerpayment->TransAmount); ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="payment_date"
                                                value="<?php echo e($managerpayment->payment_date); ?>" readonly>
                                        </div>
                                    </div>
    
                                </div>
                                  <div class="col-md-6">
                                <label for="example-text-input">Authorization <span class="text-danger">*</span></label>
                                <select class="form-control select2-show-search"  name="approval">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Authorize</button>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/payowners/paymentedit.blade.php ENDPATH**/ ?>