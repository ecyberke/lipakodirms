...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light">Post Payment</button>
                            </div>
    ...
    <?php else: ?>
     <form action="<?php echo e(route('invoice.payNowadmin')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lipakodi/public_html/v1/rms/resources/views/manualinvoices/pay.blade.php ENDPATH**/ ?>