						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Reply Email</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
							...
							<div class="col-md-12 col-lg-8 col-xl-9">
								<div class="card">
									...
									<div class="card-body">
										<div class="email-media">
											<div class="mt-0 d-sm-flex">
												...
												<div class="media-body pt-0">
													...
													<div class="media-title text-dark font-weight-semibold mt-1">From: <?php echo e($emails->user->name); ?> <span class="text-muted font-weight-semibold">( <?php echo e($emails->user->email); ?> )</span></div>
													<small class="mb-0">To: <?php echo e(Auth::user()->name); ?> - <?php echo e(Auth::user()->email); ?></small>
													
												</div>
											</div>
										</div>
										<div class="eamil-body mt-5">
											<u><h6><?php echo e($emails->subject); ?></h6></u>
										...
										<hr>
										<div class="eamil-body mt-5">
										      <?php $__empty_1 = true; $__currentLoopData = $reply; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $replies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
										      <small class="mb-0"><b>Reply From:</b>
										      <?php if($replies->user->id == Auth::user()->id): ?>
										      You - (<?php echo e($replies->user->email); ?>)
										      <?php else: ?>
										      <?php echo e($replies->user->name); ?> - (<?php echo e($replies->user->email); ?>)
										      <?php endif; ?>
										      </small>
										      
                                              <p><?php echo e($replies->reply); ?></p><hr>
                                        ...
                                        <form action="<?php echo e(route('email.store-reply')); ?>" method="post" enctype="multipart/form-data">
                                             <?php echo csrf_field(); ?>
										<div class="form-group">
												<div class="row ">
													<label class="col-sm-2 form-label">Reply Email</label>
													<div class="col-sm-10">
														<textarea rows="5" class="form-control" name="reply"></textarea>
													</div>
												</div>
											</div>
											<input type="hidden" class="form-control" name="message_id" value="<?php echo e($emails->id); ?>">
											<input type="hidden" class="form-control" name="user_id" value="<?php echo e(Auth::user()->id); ?>">
											<div class="btn-list ml-auto">
										 <button type="reset" class="btn btn-danger waves-effect m-l-5">
                                                Cancel
                                            </button>
											<button type="submit" class="btn btn-primary btn-space">Send Reply</button>
										</div>
											</form>
											</div>
									</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/chats/email-read-reply.blade.php ENDPATH**/ ?>