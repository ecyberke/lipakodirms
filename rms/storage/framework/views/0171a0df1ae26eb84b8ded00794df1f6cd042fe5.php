...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="<?php echo e(route('invoice.payInvoiceNowupdate', $managerpayment->id)); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div>
                                      ...
                                      <input class="form-control " type="text" id="example-text-input" name="invoice_type"
                                        value="<?php echo e($managerpayment->invoice_type); ?>" readonly>
                        ...
                        <div class="row">
                            <?php if($managerpayment->invoice_type === 'property'): ?>
                            <div  class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="tenant_id">
                                    ...
                                    <option value="<?php echo e($managerpayment->tenant_id); ?>"><?php echo e($managerpayment->full_name); ?></option>
                                  </select>
                                </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                     <div class="form-group">
                                           <input class="form-control " type="text" id="example-text-input" name="tenant_id"
                                        value="INV <?php echo e($managerpayment->tenant_id); ?>" readonly>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaagen/rmslesa/rms/resources/views/manualinvoices/paymentedit.blade.php ENDPATH**/ ?>