						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								...
								<li class="breadcrumb-item"><a href="{{ route('home')}}" class="d-flex"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 3L2 12h3v8h6v-6h2v6h6v-8h3L12 3zm5 15h-2v-6H9v6H7v-7.81l5-4.5 5 4.5V18z"/><path d="M7 10.19V18h2v-6h6v6h2v-7.81l-5-4.5z" opacity=".3"/></svg><span class="breadcrumb-icon"> Home</span></a></li>
									...
									<li class="breadcrumb-item active" aria-current="page">Edit Bill Category</li></li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
@section('content')
                        ...
                        <form action="{{ route('bills-categories.update', $BillCategory->id) }}" method="POST">
                        @csrf @method('PUT')
                        <div class="row">
                        <div class="col-md-6">
                        <label>Category Name *</label>
                        <input type="text" name="category_name" class="form-control" value="{{ $BillCategory->category_name }}" required>
                        </div>
                        <div class="col-sm-8"> 
                        ...
                        <select class="form-control select2-show-search" style="width: 100%"  name="type" >
                        
                        <option selected value="{{ $BillCategory->type}}">{{ $BillCategory->type }}</option>
                        <option selected value="serivice">Service Request</option>
                        <option selected value="remittance">Remittance</option>
