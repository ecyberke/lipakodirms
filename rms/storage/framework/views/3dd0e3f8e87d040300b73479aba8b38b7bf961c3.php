...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<form action="<?php echo e(route('bill.store')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-sm-6 conditionalSections" id="serviceRequestSection">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <option value="<?php echo e($test->apartment->id); ?>">Service Request - <?php echo e($test->house->house_no); ?></option>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/bills/create.blade.php ENDPATH**/ ?>