                ...
                <div class="card">
                    <div class="card-body">                       
                        {{-- <p class="text-muted m-b-30 font-14">After successful registration, you will be
                            able to add apartments and attach to the Registered 
                        </p> --}}
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="p-20">
                            ...
                            <form action="{{ route('landlord.update',$landlord->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row ">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="landlordid_number" value="{{ $landlord->landlordid_number }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control select2-show-search" id="country" name="country">
                                                    <option value="{{ $landlord->country }}">{{ $landlord->country }}</option>
                                ...
                                <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="bank_name" value="{{ $landlord->bank_name }}" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_person" value="{{ $landlord->emergency_person }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="emergency_id" value="{{ $landlord->emergency_id }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="tel" class="form-control" name="emergency_number" value="{{ $landlord->emergency_number }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="relationship" value="{{ $landlord->relationship }}">
                                    </div>
                                </div>
                            </div>
                            </div>
