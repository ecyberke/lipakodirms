						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">All Properties Income Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
...
<div class="content container-fluid">
    ...
    <!-- Content Starts -->
    <div class="card">
          <form action="<?php echo e(route('report.prop_income_report')); ?>" method="get">
            <?php echo csrf_field(); ?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                           ...
                           <p><strong>Total Collected:</strong> <span>Kshs. <?php echo e(number_format($total_paid_in)); ?></span></p>
                            <p><strong>Total Commission:</strong> <span>Kshs. <?php echo e(number_format($totals['commission'])); ?></span></p>
                            <p><strong>Total Remitted:</strong> <span>Kshs. <?php echo e(number_format($totals['remittance'])); ?></span></p>
                            <p><strong>Total Outstanding:</strong> <span>Kshs. <?php echo e(number_format($totals['total_balance'])); ?></span></p>
                            <p><strong>Period:</strong> <span><?php echo e($period); ?> </span></p>
                        </div> <!-- end col -->
                    ...
                    <div class="row table-responsive   ">
                        <table class="table dt-responsive  table-nowrap datatable" id="user">
                        <!--<table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;" id= "user">-->
                            <thead>
                              <tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-right"><?php echo e(number_format($entry['commission'])); ?></td>
                                <td class="text-right"><?php echo e(number_format($entry['remittance'])); ?></td>
                              ...
                              <tr>
                                ...
                                <th class="text-right"><?php echo e(number_format($totals['commission'])); ?></th>
                                <th class="text-right"><?php echo e(number_format($totals['remittance'])); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/report/prop_income.blade.php ENDPATH**/ ?>