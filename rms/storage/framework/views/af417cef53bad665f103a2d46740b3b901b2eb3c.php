                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php echo e($invoice->house->house_no); ?>" readonly>
                                ...
                                <div class="row">
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            <label id="tenantPhone">Tenant Account Number<span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php echo e($invoice->deposit_paid); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="number" name="carrryforward"
                                                value="<?php echo e($invoice->carrryforward); ?>">
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <label>Pre-Payment<span class="text-danger">*</span></label>
                                            <div>
                                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                value="<?php echo e($invoice->total_payable); ?>">
                               ...
                               <div class="row">
                                <div class="col-sm-3" >
                                    <div class="form-group">
                                        ...
                                        <label>Electricity & Water<span class="text-danger">*</span></label>
                                        <div>
                                            <div class="form-group">
                                ...
                                <div class="col-sm-3" >
                                    <div class="form-group">
                                        ...
                                        <label>Compound Cleaning<span class="text-danger">*</span></label>
                                        <div>
                                            <div class="form-group">
                                ...
                                <div class="col-sm-3" >
                                    <div class="form-group">
                                        ...
                                        <label>Litter Collection<span class="text-danger">*</span></label>
                                        <div>
                                            <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/bedahgra/public_html/rms/work/rms/resources/views/invoices/edit.blade.php ENDPATH**/ ?>