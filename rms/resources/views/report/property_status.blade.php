                  ...
                  <div class="row table-responsive   ">
                        <table class="table dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 500px; width: 100%;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <!--<td class="text-right">{{number_format($entry['electricity_bill'] + $entry['litter_bill'])}}</td>-->
                                <td class="text-right">{{number_format($entry['deposit_paid'])}}</td>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4 text-center" >
                                <a  href="{{\Request::fullUrl()}}&download=yes" target="_blank" class="m-2 btn btn-success waves-effect waves-light">Download Property Status Report</a>
                            </div>
                            <div class="col-md-4 text-center" >
                                <a  href="{{\Request::fullUrl()}}&download=yes&filled=no" target="_blank" class="m-2 btn btn-info waves-effect waves-light">Download Preprinted Report</a>
                            </div>
                            <div class="col-md-2 text-center" >
