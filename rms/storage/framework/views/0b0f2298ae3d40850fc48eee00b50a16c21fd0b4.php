						...
						<div class="page-header">
							...
							<div class="page-rightheader ml-auto d-lg-flex d-none">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Monthly Properties Income Report</li>
								</ol>
							</div>
						</div>
						<!--End Page header-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="title text-center">
                    <h2>MONTHLY PROPERTIES INCOME REPORT</h2>
                </div>
            </div>
        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <p><strong>Total Income:</strong> <span><?php echo e(number_format($total_paid_in)); ?></span></p>
                        </div> <!-- end col -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lesaprop/rmsprop/rms/resources/views/report/month_income.blade.php ENDPATH**/ ?>