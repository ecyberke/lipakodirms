...
<?php $__env->startSection('content'); ?>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							    <form  action="<?php echo e(route('sms.automatedSms')); ?>" method="post" class="card">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="">
                    <div class="card-body">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							    <form  action="<?php echo e(route('sms.sendSms')); ?>" method="get" class="card">
        <?php echo csrf_field(); ?>
...
<div class="form-check">
  ...
  <label class="form-check-label" for="flexRadioDefault2">
    Send real message
                        ...
                        <div class="row">
                                                <div class="col-sm-12">
                                                   <h4>Sms Count:(<?php echo e($sms_count); ?>)</h4>
                                                   <h4>First 5 sms sample:</h4>
                                                    <?php $__empty_1 = true; $__currentLoopData = $smses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div>
                                                   <h5>Phone:<?php echo e($sms['to']); ?></h5>
                                                   <p><?php echo e($sms['text']); ?></p>
                                                   </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/sms/custom.blade.php ENDPATH**/ ?>