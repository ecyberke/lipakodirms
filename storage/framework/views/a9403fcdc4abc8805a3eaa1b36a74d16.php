    ...
    $(function () {
        $('#servicerequest-table').DataTable({
            ...
            serverSide: true,
             "pageLength": 25,
             "order": [[ 1, "desc" ]],
            ajax: '<?php echo route('api.service.provider'); ?>',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
        ...
        $(document).on('submit','.delete-house',function(event){
            return confirm('Are you sure you want to delete this request ? The action cannot be reversed');            
        });
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/service_providers/index.blade.php ENDPATH**/ ?>