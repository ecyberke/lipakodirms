...
<div class="alert alert-warning alert-dismissible fade show" role="alert">
    ...
    <strong>Subscription Renewal Notice:</strong> Your subscription expires in <?php echo e($subscription_days_left); ?> day(s).
    Please renew to avoid service interruption.
    <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
</div>
<?php endif; ?>

<?php if(isset($sms_low) && $sms_low): ?>
...
<div class="row mb-3" style="margin-top:10px;">
    <div class="col-9">
        ...
        <div class="card mb-0" style="border-left: 4px solid #1A4FA8;">
            <div class="card-body py-2 px-3">
                ...
                <span class="font-weight-bold <?php echo e(isset($sms_low) && $sms_low ? 'text-danger' : 'text-success'); ?>">
                    <?php echo e($currency); ?> <?php echo e($balance); ?>
    ...
    <div class="col-3 d-flex align-items-center justify-content-end">
        <a href="<?php echo e(route('onboarding.wizard')); ?>" class="btn btn-sm btn-outline-primary w-100">
						...
						<div class="row">
							<div class="col-xl-12 col-md-12 col-lg-12">
								<div class="row">
									...
									<div class="col-xl-3 col-lg-3 col-md-12">
										<div class="card">
											<div class="card-body"><a  href="<?php echo e(route('tenant.all')); ?>" >
											...
											<div class="card-body">
												<div class="row">
													<div class="col">
														...
														<h3 class="mb-0 font-weight-bold">Ksh.<?php echo e(number_format($income_today)); ?></h3>
													</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col">
														...
														<h3 class="mb-0 font-weight-bold">Ksh.<?php echo e(number_format($month_income)); ?></h3>
													</div>
													<div class="col col-auto">
														<div id="spark2"></div>
													</div>
												...
												<div class="row">
													<div class="col">
														<p class="mb-1">Outstanding This Month</p>
															<h3 class="mb-0 font-weight-bold">Ksh.<?php echo e(number_format($arrears_month)); ?></h3>
													</div>
													<div class="col col-auto">
														<div id="spark3"></div>
													</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col">
														...
														<h3 class="mb-0 font-weight-bold">Ksh.<?php echo e(number_format($arrears)); ?></h3>
													</div>
													<div class="col col-auto">
														<div id="spark3"></div>
													</div>
                                ...
                                <table class="table table-striped table-bordered text-nowrap" style="width:100%" >
                                    ...
                                    <tbody>
                                       <?php $__empty_1 = true; $__currentLoopData = $servicerequest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $object): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class=""><?php if($object->tenant_id == null): ?> General Apartment Service <?php else: ?><?php echo e(($object->tenant->full_name)); ?> <?php endif; ?></td>
                                            <td class=""><?php echo e(($object->apartment->name)); ?></td>
                                            <td class="text-uppercase"><?php if($object->house_id == null): ?> General Apartment Service <?php else: ?><?php echo e(($object->house->house_no)); ?> <?php endif; ?></td>
                                             <td class="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ecyberco/domains/lipakodi.ecyber.co.ke/public_html/rms/resources/views/admins/index.blade.php ENDPATH**/ ?>