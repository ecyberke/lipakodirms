...
@section('content')
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
							     ...
							     <form action="{{ route('invoice.accountupdate', $account->id)}}" method="post" class="card">
        @csrf
                        ...
                        <div class="row">
                           ...
                           <div  class="col-md-6">
                                ...
                                <div>
                                  ...
                                  <input class="form-control" type="text" name="InvoiceNumber" value="{{$account->InvoiceNumber}}" readonly >
                                </div>
                                </div>
                            ...
                            <div  class="col-md-6">
                                ...
                                <select class="form-control select2-show-search" style="width: 100%" name="InvoiceNumber">
                                    ...
                                    <option value="{{$ten->account_number}}">{{$ten->full_name}} - {{$ten->account_number}}</option>
                                    @empty
                                    @endforelse
                                  </select>
                                </div>
